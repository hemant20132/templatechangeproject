...
<h4 class=\"widgettitle\">".$titolo_form_dati_cliente."</h4>
...
echo "<input type=\"text\" class=\"form-conrol input-sm\" id=\"cognome\" name=\"cognome\" value=\"$cognome\">";
if ($attiva_prefisso_clienti == "s") echo $prefisso_clienti;
echo ",".mex("nome",$pag).": <input type=\"text\" class=\"form-conrol input-sm\" name=\"nome\" value=\"$nome\">;
 ".mex("soprannome",$pag).": <input type=\"text\" name=\"soprannome\" class=\"form-conrol input-sm\" value=\"$soprannome\">;<br>
".mex("sesso",$pag).": <span class=\"field\"><select class=\"uniformselect\" name=\"sesso\">
...
<option value=\"f\"$sel_f>f</option>
 ...
 ".mex("lingua",$pag).": <span class=\"field\"><select class=\"unifromselect\" name=\"lingua_cli\">";
...
echo "<span class=\"field\"><select class=\"uniformselect\" name=\"prenota_cli_osp\"$selected>";
for ($n_t = 1 ; $n_t <= $num_tipologie ; $n_t++) {
for ($num1 = 1 ; $num1 <= ${"num_app_richiesti".$n_t} ; $num1++) {
...
$sel_mnascita = "<span class=\"field\" ><select name=\"mesenascita\" class=\"uniformselect\">
<option value=\"\" selected>--</option>";
...
echo "<hr style=\"width: 95%\">
".mex("Residenza",$pag).":<span class=\"field\"> <select class=\"uniformselect\" name=\"via\">
...
<input class=\"form-control input-sm\" type=\"text\" name=\"nomevia\" value=\"$via\">
Nº<input class=\"form-control input-sm\" type=\"text\" name=\"numcivico\" size=\"4\" value=\"$numcivico\">,
  ".mex("CAP",$pag)."<input type=\"text\" class=\"form-control input-sm\" name=\"cap\" size=\"6\" value=\"$cap\">,<br>
...
echo "<input type=\"text\" name=\"documento\" class=\"form-control input-sm\" value=\"$documento\">
".mex("scadenza",$pag).": ";
$sel_gscaddoc = "<span class=\"field\"><select class=\"uniformselect\" name=\"giornoscaddoc\">
<option value=\"\" selected>--</option>";
for ( $num = 1; $num <= 31; $num = $num + 1) {
if (strlen($num) == 1) $num = "0".$num;
...
$sel_mscaddoc = "<span class=\"field\"><select class=\"uniformselect\" name=\"mesescaddoc\">
<option value=\"\" selected>--</option>";
for ( $num = 1; $num <= 12; $num = $num + 1) {
if (strlen($num) == 1) $num = "0".$num;
...
<hr style=\"width: 95%\">
".mex("Numero di telefono",$pag).": <input type=\"text\" class=\"form-control input-sm\" name=\"telefono\" value=\"$telefono\"> 
".mex("Secondo telefono",$pag).": <input type=\"text\" class=\"form-control input-sm\" name=\"telefono2\" value=\"$telefono2\"><br>
".mex("Terzo telefono",$pag).": <input type=\"text\" class=\"form-control input-sm\" name=\"telefono3\" value=\"$telefono3\">
".mex("Numero di fax",$pag).": <input type=\"text\" class=\"form-control input-sm\" name=\"fax\" value=\"$fax\"><br>
E-mail: <input type=\"text\" class=\"form-control input-sm\" name=\"email\" size=\"30\" value=\"$email\">";
...
testo += '<hr width=\"35%\">\
'+n1+'. ".addslashes(mex("Cognome",$pag)).": <input type=\"text\" class=\"form-control input-sm\" id=\"cognome'+suff+'\" name=\"cognome'+suff+'\"><input type=\"button\" class=\"cpbutton\" onclick=\"cp_val(\'cognome'+suff+'\',\'cognome'+suffcp+'\',\'\')\" value=\"#\">,\
 ".addslashes(mex("nome",$pag)).": <input type=\"text\" class=\"form-control input-sm\" name=\"nome'+suff+'\">;\
 ".addslashes(mex("sesso",$pag)).":<span class=\"field\"> <select class=\"uniformselect\" name=\"sesso'+suff+'\">\
<option value=\"\" selected>-<\/option>\
...
$sel_gnascita = "<span class=\"field\"><select class=\"uniformselect\" name=\"giornonascita'+suff+'\">\
<option value=\"\" selected>--<\/option>";
for ( $num = 1; $num <= 31; $num = $num + 1) {
if (strlen($num) == 1) $num = "0".$num;
...
$sel_gnascita .= "<\/select></span>";
$sel_mnascita = "<span class=\"field\"><select class=\"uniformselect\" name=\"mesenascita'+suff+'\">\
<option value=\"\" selected>--<\/option>";
for ( $num = 1; $num <= 12; $num = $num + 1) {
if (strlen($num) == 1) $num = "0".$num;
...
echo "/<input type=\"text\" class=\"form-control input-sm\" name=\"annonascita'+suff+'\" size=\"5\" maxlength=\"4\" value=\"19\"> (".addslashes(mex("anno con 4 cifre",$pag))."),\
...
echo "<input type=\"text\" class=\"form-control input-sm\" name=\"documento'+suff+'\">\
 ".addslashes(mex("scadenza",$pag)).": ";
$sel_gscaddoc = "<span class=\"field\"><select class=\"uniformselect\" name=\"giornoscaddoc'+suff+'\">\
<option value=\"\" selected>--<\/option>";
for ( $num = 1; $num <= 31; $num = $num + 1) {
if (strlen($num) == 1) $num = "0".$num;
$sel_gscaddoc .= "<option value=\"$num\">$num<\/option>";
...
$sel_gscaddoc .= "<\/select></span>";
$sel_mscaddoc = "<span class=\"field\"><select class=\"uniform-select\" name=\"mesescaddoc'+suff+'\">\
<option value=\"\" selected>--<\/option>";
for ( $num = 1; $num <= 12; $num = $num + 1) {
if (strlen($num) == 1) $num = "0".$num;
$sel_mscaddoc .= "<option value=\"$num\">$num<\/option>";
...
echo "/<span class=\"field\"><select class=\"uniformselect\" name=\"annoscaddoc'+suff+'\">";
$anno_corr = date("Y",(time() + (C_DIFF_ORE * 3600)));
...
if ($datiprenota) {
echo "<input class=\"btn btn-primary\" id=\"inse\" type=\"submit\" name=\"inserire\" value=\"".mex("Inserisci i dati",$pag)."\"><br><br>
...
echo "
<input class=\"btn btn-primary\" id=\"inse\" type=\"submit\" name=\"inseriscicliente\" value=\"".mex("Inserisci i dati",$pag)."\">
";
