...
echo ", ".mex("metodo di pagamento",$pag).":</label>
 <span class=\"field\"><select class=\"uniformselect\" name=\"metodo_pagamento\" onchange=\"document.getElementById('canc_pag').checked='1';\">
<option value=\"\">----</option>";
...
echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"torna\" value=\"".mex("NO",$pag)."\">
</div></form>";
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"mese\" value=\"$mese\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"torna\" value=\"OK\">
<br></div></form>";
...
if ($dati_osp) {
$select_osp = "<span class=\"field\"><select class=\"uniformselect\" name=\"id_ospite\">
...
<input type=\"text\"  class=\"form-control input-sm\" name=\"id_nuovo_cliente\" size=\"5\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Cambia cliente",$pag)."\">
</div></form>";
...
<input type=\"hidden\" name=\"idprenota_origine\" value=\"$idprenota_origine\">
<input type=\"hidden\" name=\"id_prenota\" value=\"$id_prenota_int\">";
if ($errore != "SI") echo "<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Annulla",$pag)."\">";
else echo "<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Torna indietro",$pag)."\">";
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Prova di nuovo",$pag)."\">
...
$n_prezzo_costo_agg[$numca] = (double) calcola_prezzo_totale_costo($dati_cap,$numca,$inizioperiodo,$fineperiodo,$n_settimane_costo[$numca],$n_moltiplica_costo[$numca],$costo_tariffa,$tariffesettimanali,$costo_totale_provvisorio,$caparra,$numpersone);
...
$num_reg = ($dati_cap['num'] + $numca - 1);
$costo_totale_provvisorio = $n_costo_tot + $n_costo_agg_tot - $d_costo_agg_tot;
$n_prezzo_costo_agg[$num_reg] = (double) calcola_prezzo_totale_costo($dati_ca,$num_costo,$inizioperiodo,$fineperiodo,$n_settimane_costo[$num_reg],$n_moltiplica_costo[$num_reg],$costo_tariffa,$tariffesettimanali,$costo_totale_provvisorio,$caparra,$numpersone);
...
echo " ".mex("Metodo di pagamento",$pag).":
 <span class=\"field\"><select class=\"uniformselect\" name=\"metodo_pagamento$id_prenota\">
<option value=\"\">----</option>";
$metodi_pagamento = explode(",",$metodi_pagamento);
...
<br><input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Continua",$pag)."\">
...
<input type=\"hidden\" name=\"idprenota_origine\" value=\"$idprenota_origine\">
<input type=\"hidden\" name=\"id_prenota\" value=\"$id_prenota_int\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"torna\" value=\"".mex("OK",$pag)."\">
<br></div></form>";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"torna\" value=\"".mex("rigenera",$pag)."\" style=\"font-size: 80%;\">
</div></form></div></div>";
} # fine if ($priv_mod_codice == "s")
echo "</td></tr></table>";
...
echo "
 <div class=\"widgetbox\">
 <h4 class=\"widgettitle\>Modify Reservation</h4>
 <div class=\"widgetcontent\">

<div class=\"rbox\">&nbsp;".mex("Prenotazione a nome di",$pag).":<br>";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"vai\" value=\"".mex("Modifica i dati del cliente",$pag)."\">
</div></form>";
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"origine\" value=\"modifica_prenota.php?mese=$mese&amp;tipo_tabella=$tipo_tabella&amp;id_prenota=$idprenota_origine2&amp;origine=$origine\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Modifica gli ospiti",$pag)."\">";
/*if ($num_id_prenota == 1) echo "<input type=\"hidden\" name=\"id_prenota\" value=\"$id_prenota\">";
else {
echo " ".mex("della prenotazione",$pag)."
<span class=\"field\"><select class=\"uniformselect\" name=\"id_prenota\">";
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Modifica nell'anno precedente",$pag)."\">";
} # fine if ($id_prenota_prec)
echo "</div></form><br><br>";
} # fine if ($id_prenota_prec)
...
echo " ".mex("cambia in",$pag)." <span class=\"field\"><select class=\"uniformselect\" name=\"id_nuovo_utente_inserimento\">
...
echo "&nbsp;&nbsp;&nbsp;&nbsp;";
if (!$d_checkin_min) echo "<input class=\"smallbtn btn-primary\" type=\"submit\" name=\"ins_checkin\" value=\"".mex("registra entrata",$pag)."\">";
else echo "<input class=\"smallbtn btn-primary\" type=\"submit\" name=\"canc_checkin\" value=\"".mex("cancella entrata",$pag)."\">";
...
echo "&nbsp;&nbsp;&nbsp;&nbsp;";
if (!$d_checkout_min) echo "<input class=\"smallbtn btn-primary\" type=\"submit\" name=\"ins_checkout\" value=\"".mex("registra uscita",$pag)."\">";
else echo "<input class=\"smallbtn btn-primary\" type=\"submit\" name=\"canc_checkout\" value=\"".mex("cancella uscita",$pag)."\">";
...
echo mex("cambia in",$pag)." ";
if ($d_data_inizio != "~~~~") {
echo "<span class=\"field\"><select class=\"uniformselect\" name=\"n_data_stima_checkin\">";
$formato_vedi = "d-m-Y";
...
echo "<span class=\"field\"><select class=\"uniformselect\" name=\"n_ora_stima_checkin\">
<option value=\"\"$sel>--</option>";
...
echo "</select>:<span class=\"field\"><select class=\"uniformselect\" name=\"n_min_stima_checkin\">
<option value=\"\"$sel>--</option>";
...
echo "</td><td>";
if ($priv_mod_num_persone == "s") echo mex("cambia in",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"n_numpersone\" value=\"$n_numpersone\" size=\"2\" maxlength=\"2\">";
...
<span class=\"field\"><select class=\"uniformselect\" name=\"sposta_appartamento\">
<option value=\"\"$sel>--</option>";
...
<span class=\"field\"><select class=\"uniformselect\" class=\"smallsel85\" name=\"n_appartamento\">
<option value=\"\"$sel>--</option>";
...
<input type=\"text\"  class=\" form-control input-sm\" class=\"smallsel85\" id=\"list_ap\" name=\"n_lista_app\" value=\"$n_lista_app\"$onclick size=\"15\"> ";
...
(<span class=\"field\"><select class=\"uniformselect\" class=\"smallsel85\" id=\"comb_ap\" onchange=\"agg_comb_app()\">
...
echo "·".mex("Nº di piano",$pag).": <span class=\"field\"><select class=\"uniformselect\" class=\"smallsel85\" name=\"n_num_piano\">
<option value=\"\"$sel>--</option>";
...
echo "</select>
 ".mex("e/o di casa",$pag).": <span class=\"field\"><select class=\"uniformselect\" class=\"smallsel85\" name=\"n_num_casa\">
<option value=\"\"$sel>--</option>";
...
echo "</select>
 ".mex("e/o di persone",$pag).": <span class=\"field\"><select class=\"uniformselect\" class=\"smallsel85\" name=\"n_num_persone_casa\">
<option value=\"\"$sel>--</option>";
...
echo "".mex("numero",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"n_id_prenota_comp\" value=\"$n_id_prenota_comp\" size=\"6\">";
...
echo "<span class=\"field\"><select class=\"uniformselect\" id=\"tcomm\" class=\"smallsel\" name=\"tipo_commento\">
...
<textarea name=\"n_commento\" rows=2 class=\"form-control input-default\" cols=40 style=\"white-space: pre; overflow: auto;\"$onclick>$n_commento</textarea><br>
...
echo mex("cambia in",$pag)." <span class=\"field\"><select class=\"uniformselect\" name=\"n_origine_prenota\">
<option value=\"\"$sel>----</option>";
...
echo mex("cambia in",$pag)." <span class=\"field\"><select class=\"uniformselect\" name=\"n_nometipotariffa$suff_idpr\">
<option value=\"\"$sel>----</option>";
...
echo mex("cambia in",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"n_sconto\" value=\"$n_sconto\" size=\"7\">
 <span class=\"field\"><select class=\"uniformselect\" name=\"tipo_val_sconto\">
...
echo mex("cambia in",$pag)." <input type=\"text\"  class=\"form-control input-sm\" name=\"n_caparra\" value=\"$n_caparra\" size=\"7\">
 <span class=\"field\"><select class=\"uniformselect\" name=\"tipo_val_caparra\">
<option value=\"val\"$sel_val>$Euro</option>
<option value=\"perc_tar\"$sel_perc_tar>".mex("% della tariffa","prenota.php")."</option>
</select><br><label>
...
echo mex("cambia in",$pag)." <span class=\"field\"><select class=\"uniformselect\" name=\"n_met_paga_caparra\">
<option value=\"\"$sel>----</option>";
$metodi_pagamento = explode(",",$metodi_pagamento);
for ($num1 = 0 ; $num1 < count($metodi_pagamento) ; $num1++) {
...
echo mex("cambia in",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"n_commissioni\" value=\"$n_commissioni\" size=\"7\">
 <span class=\"field\"><select class=\"uniformselect\" name=\"tipo_val_commissioni\">
<option value=\"val\"$sel_val>$Euro</option>
<option value=\"perc_tar\"$sel_perc_tar>".mex("% della tariffa","prenota.php")."</option>
...
echo " ".mex("per",$pag)." ";
if ($priv_mod_costi_agg == "s" and $dati_cap[$numca]['numsett'] == "c") echo "<input type=\"text\"  class=\" form-control input-sm\" name=\"$sett_costoaggiuntivo\" size=\"3\" maxlength=\"3\" value=\"".$$sett_costoaggiuntivo."\">";
...
if ($priv_mod_costi_agg == "s" and $dati_cap[$numca]['moltiplica'] == "c") echo "<input type=\"text\"  class=\" form-control input-sm\" name=\"$molt_costoaggiuntivo\" size=\"3\" maxlength=\"12\" value=\"".$$molt_costoaggiuntivo."\">";
...
if ($priv_mod_costi_agg == "s" and $dati_cap[$numca]['moltiplica'] == "c") echo "<input type=\"text\"  class=\" form-control input-sm\" name=\"$molt_costoaggiuntivo"."_sett$num1\" size=\"3\" maxlength=\"12\" value=\"".${$molt_costoaggiuntivo."_sett".$num1}."\">";
...
<span class=\"field\"><select class=\"uniformselect\" name=\"modo_aggiorna_pagato\">";
...
echo "<option value=\"caparra\"$sel>".mex("caparra ",$pag)."</option>
 ...
 <input type=\"text\"  class=\" form-control input-sm\" name=\"n_pagato\" value=\"$n_pagato\" size=\"8\"> $Euro</td>";
...
</label><input type=\"text\"  class=\" form-control input-sm\" name=\"nomecostofinale0\" size=\"13\" value=\"$nomecostofinale0\" onclick=\"document.getElementById('nca_0').checked='1';\">
<label for=\"nca_0\">\" ".mex("di",$pag)." </label>
<input type=\"text\"  class=\" form-control input-sm\" name=\"val_costofinale0\" value=\"$val_costofinale0\" size=\"7\" onclick=\"document.getElementById('nca_0').checked='1';\">
</label><label for=\"nca_0\"> $Euro, ".mex("da moltiplicare per",$pag).":</label>
<input type=\"text\"  class=\" form-control input-sm\" name=\"nummoltiplica_cf0\" size=\"3\" maxlength=\"12\" value=\"$nummoltiplica_cf0\" onclick=\"document.getElementById('nca_0').checked='1';\">";
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"$numsettimane\" size=\"3\" maxlength=\"3\" value=\"".$$numsettimane."\"
...
if ($dati_ca[$num1]['molt_max'] != "n") $testo_costo .= "<input type=\"text\"  class=\" form-control input-sm\" name=\"$nummoltiplica_ca\" size=\"3\" maxlength=\"12\" value=\"".$$nummoltiplica_ca."\"
 onclick=\"document.getElementById('nca_$numcostiagg_v').checked='1';\">";
else {
$testo_costo .= "<span class=\"field\"><select class=\"uniformselect\" name=\"$nummoltiplica_ca\" onclick=\"document.getElementById('nca_$numcostiagg_v').checked='1';\">";
...
$sel_costi = "</label><span class=\"field\"><select class=\"uniformselect\" name=\"idcostoagg$numcostiagg\" onclick=\"document.getElementById('nca_$numcostiagg').checked='1';\">";
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"$numsettimane\" value=\"$valnumsettimane\" size=\"3\" maxlength=\"3\"
...
if (!$chiedi_combina[$categoria]['molt_max_num']) echo "<input type=\"text\"  class=\" form-control input-sm\" name=\"$nummoltiplica_ca\" value=\"$valnummoltiplica_ca\" size=\"3\" maxlength=\"12\"
 onclick=\"document.getElementById('nca_$numcostiagg').checked='1';\">";
else {
echo "<span class=\"field\"><select class=\"uniformselect\" name=\"$nummoltiplica_ca\" onclick=\"document.getElementById('nca_$numcostiagg').checked='1';\">";
...
<input class=\"btn btn-primary\" id=\"modi\" type=\"submit\" name=\"modificaprenotazione\" value=\"$frase_modifica_prenota\">
</div>
</div></form>
...
<input class=\"btn btn-primary\" id=\"canc\" type=\"submit\" name=\"cancella\" value=\"$frase_cancella_prenota\">
</div></form>
...
echo "".ucfirst(mex("documento di tipo",$pag))."
 <span class=\"field\"><select class=\"uniformselect\" id=\"lcon\" name=\"numero_contratto\">";
...
echo "</select>
 <input class=\"btn btn-primary\" id=\"tcon\" type=\"submit\" value=\"".ucfirst(mex("visualizza",$pag))."\">
...
echo "<br>(".mex("con costo agg.",$pag)."
 <span class=\"field\"><select class=\"uniformselect\" name=\"num_costo_agg_sel\">
...
<input class=\"btn btn-primary\" id=\"indi\" type=\"submit\" name=\"torna\" value=\"".mex("Torna indietro",$pag)."\">
</div></form></div>
