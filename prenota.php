...
<br><input type=\"text\" class=\"btn btn-primary\" type=\"submit\" name=\"torna\" value=\"".mex("Torna indietro",$pag)."\">
</div></form>";
...
echo "
<input  type=\"text\" class=\"btn btn-primary\" type=\"submit\" name=\"utilizza\" value=\"".mex("Utilizza anche gli appartamenti della regola 1",'unit.php')."\"><br>
</div></form>";
if ($n_tronchi > 1) {
...
include ("./includes/dati_form_prenotazione.php");
echo "
<input type=\"text\" class=\"btn btn-primary\" type=\"submit\" name=\"spezza_senza_app_agenzia\" value=\"".mex("Spezza la prenotazione in",$pag)." $n_tronchi ".mex("parti",$pag)."\">
...
include ("./includes/dati_form_prenotazione.php");
echo "
<input type=\"text\" class=\"btn btn-primary\" type=\"submit\" name=\"spezza_senza_app_agenzia\" value=\"".mex("Spezza la prenotazione in",$pag)." $n_tronchi ".mex("parti",$pag)."\"><br>
</div></form>";
} # fine if ($n_tronchi > 1)
...
echo "<br><div style=\"\"><b>".mex("Non si è potuto inserire la prenotazione a nome di",$pag)." $cognome ".mex("dal",$pag)." ".$data_inizio_f[$n_t]." ".mex("al",$pag)." ".$data_fine_f[$n_t]."
...
echo "<br><div style=\"position:absolute;width:500px;height:40px;display:inline;color:red;\"><b>".mex("Non si è potuto inserire la prenotazione a nome di",$pag)." $cognome ".mex("dal",$pag)." ".$data_inizio_f[$n_t]." ".mex("al",$pag)." ".$data_fine_f[$n_t]."
...
$settimane_costo = ${"settimane_costo".$numca."_".$n_t."t".$num1};
$moltiplica = ${"moltiplica".$numca."_".$n_t."t".$num1};
$prezzo_costo_vett[$num_costo] = calcola_prezzo_totale_costo($dati_ca,$num_costo,$inizioperiodo,$fineperiodo,$settimane_costo,$moltiplica,$costo_tariffa,$lista_tariffe_sett,$costo_tariffa_tot,$caparra,$numpersone);
...
<input class=\"text\" class=\"btn btn-primary\" type=\"submit\" name=\"vai\" value=\"".mex("Modifica la prenotazione",$pag)." $idprenota\">
</div></form></div>
<hr style=\"width: 95%\">";
...
<input type=\"text\" class=\"btn btn-primary\" type=\"submit\" name=\"vedi_contr\" value=\"".mex("Modifica come gruppo le prenotazioni inserite",$pag)."\">
</div></form></div><br>
<hr style=\"width: 95%\">";
...
echo "<input type=\"text\" class=\"btn btn-primary\" type=\"submit\" name=\"ok\" value=\"".mex("Torna indietro",$pag)."\"><br></form>";
} # fine if ($torna_invece_di_ok == "SI")
else {

echo "<br><div style=\"text-align: center;\">
<input type=\"text\" class=\"btn btn-primary\" type=\"submit\" name=\"ok\" value=\"".mex("Inserisci una nuova prenotazione",$pag)."\"></div>
<br></div></form>

<form accept-charset=\"utf-8\" method=\"post\" action=\"inizio.php\"><div style=\"text-align: center;\">
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input  type=\"text\" class=\"btn btn-primary\" type=\"submit\" name=\"torna\" value=\"".mex("Torna al menù principale",$pag)."\">
...
echo "
            <div class=\"widgetbox \">
                <h4 class=\"widgettitle\">".mex("Inserisci una nuova prenotazione",$pag)."</h4>
                <div class=\"widgetcontent \">
<form accept-charset=\"utf-8\" method=\"post\" action=\"clienti.php\" class=\"form-horizontal\" role=\"form\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
...
echo "
                        <div class=\"form-group\">
                            <label for=\"cognome\" class=\"col-md-2 control-label\">".mex("Cliente titolare: cognome",$pag)."</label>
                            <div class=\"col-md-10\">
                                <input type=\"text\" class=\"form-control input-sm\" name=\"cognome\" value=\"$cognome\" id=\"cognome\" placeholder=".mex("Cliente titolare: cognome",$pag).">
                            </div>
                        </div>
";
...
echo "
                       <div class=\"form-group\">
                            <label for=\"nome\" class=\"col-md-2 control-label\">".mex("nome",$pag)."</label>
                            <div class=\"col-md-10\">
                                <input type=\"text\" class=\"form-control input-sm\" name=\"nome\" value=\"$nome\" id=\"nome\" placeholder=".mex("nome",$pag).">
                            </div>
                        </div>
";
...
echo "
   ...
   <label for=\"dateFrom\" class=\"col-md-2 control-label\">".mex("Tipo di tariffa",$pag)."</label>
   <label for=\"dateFrom\" class=\"col-md-2 control-label\">".mex("Tipo di tariffa",$pag)."</label>
   <span class=\"field\">  
   <select name=\"nometipotariffa$n_t\" class=\"uniformselect\">
...
echo "<span class=\"field\"> <select class=\"uniformselect\" name=\"tipo_val_sconto$n_t\" id=\"tvsc$n_t\">
...
<table cellspacing=\"0\" cellpadding=\"0\" border= \"0\"><tr><td>" . mex("Tipo di tariffa",$pag) . ": 
<span class=\"field\">
<select name=\"nometipotariffa$n_t\" class=\"uniformselect\">
<option value=\"\"$sel>----</option>";
$num_tariffe = 0;
...
<td><span class=\"field\">
<select class=\"uniformselect\" name=\"tipo_sconto$n_t\" id=\"tsc$n_t\" onchange=\"agg_tsc('$n_t')\">
<option value=\"sconto\"$sel_sconto>".mex("sconto",$pag)."</option>
<option value=\"tot\"$sel_tot>".mex("prezzo totale",$pag)."</option>
<option value=\"tot_sett\"$sel_tot_sett>".mex("prezzo totale $parola_settimanale",$pag)."</option>
<option value=\"tar\"$sel_tar>".mex("prezzo tarffa",$pag)."</option>
...
<input type=\"text\" name=\"sconto$n_t\" size=\"7\" value =\"".${"sconto".$n_t}."\">";
$sel_val = "";
$sel_tot = "";
$sel_tar = "";
if (!${"tipo_val_sconto".$n_t}) $sel_val = " selected";
...
<select class=\"uniformselect\" name=\"tipo_val_sconto$n_t\" id=\"tvsc$n_t\">
<option value=\"\"$sel_val>$Euro</option>
<option value=\"tot\"$sel_tot>".mex("% del totale",$pag)."</option>
<option value=\"tar\"$sel_tar>".mex("% della tariffa",$pag)."</option>
</select></span></td>";
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"tipo_val_caparra$n_t\">
<option value=\"\"$sel_val>$Euro</option>
<option value=\"tar\"$sel_tar>".mex("% della tariffa",$pag)."</option>
</select></span> (".mex("se diversa dalla normale",$pag).")";
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"appartamento$n_t\">
<option value=\"\">--</option>";
...
echo "</select></span>
 ".mex("e/o di casa",$pag).":<span class=\"field\"> <select name=\"num_casa$n_t\" class=\"uniformselect\">
<option value=\"\"$sel>--</option>";
...
echo "</select></span> ".mex("e/o di persone",$pag).":<span class=\"field\"> <select class=\"uniformselect\" name=\"num_persone_casa$n_t\">
<option value=\"\"$sel>--</option>";
...
<span class=\"field\">
 <select name=\"giorno_stima_checkin$n_t\" class=\"uniformselect\" >
...
echo "<span class=\"field\"><select class=\"uniformselect\" name=\"ora_stima_checkin$n_t\">
<option value=\"\"$sel>--</option>";
...
echo "</select></span>:<span class=\"field\"><select class=\"uniformselect\" name=\"min_stima_checkin$n_t\">
<option value=\"\"$sel>--</option>";
...
echo mex("Metodo pagamento caparra",$pag).":<span class=\"field\"> <select class=\"uniformselect\" name=\"met_paga_caparra$n_t\">
<option value=\"\"$sel>----</option>";
$metodi_pagamento = explode(",",$metodi_pagamento);
...
echo mex("Origine",$pag).":<span class=\"field\" <select class=\"uniformselect\" name=\"origine_prenota$n_t\">
<option value=\"\"$sel>----</option>";
$origini_prenota = explode(",",$origini_prenota);
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"tipo_val_commissioni$n_t\">
<option value=\"\"$sel_val>$Euro</option>
<option value=\"tar\"$sel_tar>".mex("% della tariffa",$pag)."</option>
...
echo "<input type=\"text\" class=\"form-control input-sm\" name=\"num_app_richiesti$n_t\" size=\"2\" maxlength=\"3\" value =\"".${"num_app_richiesti".$n_t}."\">.";
if ($num_tipologie == $n_t and $num_tipologie < 999) echo "</td><td style=\"width: 80px;\"></td><td><input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_tipologie\" value =\"".mex("Aggiungi altre tipologie",$pag)."\">";
echo "</td></tr></table>";
if ($num_tipologie == 1 and $priv_ins_multiple == "s") echo $mess_app_vicini;
echo "<br>";
} # fine if ($priv_ins_multiple != "n")
...
echo "<div class=\"checkbox\"><label><input type=\"checkbox\" name=\"conferma_prenota$n_t\" value=\"SI\"$checked>
".ucfirst(mex("confermata",$pag)).".</label></div><br>";
...
<div class=\"checkbox\"><label><input type=\"checkbox\" id=\"ca_$numcostiagg_v"."_$n_t\" name=\"$costoagg"."_$n_t\" value=\"SI\"$checked>
...
$testo_costo .= ", ".mex("nº di $parola_settimane da applicare",$pag).":</label></div>

<input type=\"text\" class=\"form-control input-sm\" name=\"$numsettimane"."_$n_t\" value=\"$valnumsettimane\" size=\"3\" maxlength=\"3\"
...
if ($dati_ca[$num1]['molt_max'] != "n") $testo_costo .= "<input class=\"form-control input-sm\" type=\"text\" name=\"$nummoltiplica_ca"."_$n_t\" value=\"$valnummoltiplica_ca\" size=\"3\" maxlength=\"12\"
 onclick=\"document.getElementById('ca_$numcostiagg_v"."_$n_t').checked='1';\">";
else {
$testo_costo .= "<span class=\"field\"><select class=\"uniformselect\" name=\"$nummoltiplica_ca"."_$n_t\" onclick=\"document.getElementById('ca_$numcostiagg_v"."_$n_t').checked='1';\">";
...
$sel_costi = "</label><span class=\"field\"><select class=\"uniformselect\" name=\"idcostoagg$numcostiagg"."_$n_t\" onclick=\"document.getElementById('ca_$numcostiagg"."_$n_t').checked='1';\">";
...
$sel_costi .= "</select></span><label for=\"ca_$numcostiagg"."_$n_t\">";
...
<label><div class=\"checkbox\"><label><input type=\"checkbox\" id=\"ca_$numcostiagg"."_$n_t\" name=\"costoagg$numcostiagg"."_$n_t\" value=\"SI\"$checked>
...
echo ", ".mex("nº di $parola_settimane da applicare",$pag).":</label></div>
<input type=\"text\" class=\"form-control input-sm\" name=\"$numsettimane"."_$n_t\" value=\"$valnumsettimane\" size=\"3\" maxlength=\"3\"
...
if (!$chiedi_combina[$categoria]['molt_max_num']) echo "<input type=\"text\" class=\"form-control input-sm\" name=\"$nummoltiplica_ca"."_$n_t\" value=\"$valnummoltiplica_ca\" size=\"3\" maxlength=\"12\"
 onclick=\"document.getElementById('ca_$numcostiagg"."_$n_t').checked='1';\">";
else {
echo "<span class=\"field\"><select name=\"$nummoltiplica_ca"."_$n_t\" class=\"uniformselect\" onclick=\"document.getElementById('ca_$numcostiagg"."_$n_t').checked='1';\">";
...
echo "<span class=\"field\"> <select class=\"uniformselect\" name=\"tipo_commento$n_t\">
...
<div class=\"form-group\">
<div class=\"col-md-10\">
<textarea class=\"form-control input-default\" name=\"commento$n_t\" rows=3 cols=45 style=\"white-space: pre; overflow: auto;\">".${"commento".$n_t}."</textarea></div></div>  <br>";
...
<input type=\"text\" class=\"btn btn-primary\" id=\"inse\" type=\"submit\" name=\"ins_nuova_prenota\" value=\"".mex("Inserisci la prenotazione",$pag)."\">
<hr style=\"width: 95%\">
</form><br>
<form accept-charset=\"utf-8\" method=\"post\" action=\"inizio.php\"><div style=\"text-align: center;\">
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
...
<input type=\"text\" class=\"btn btn-primary\" id=\"indi\" type=\"submit\" name=\"torna\" value=\"".mex("Torna al menù principale",$pag)."\">
<br></div></form></div><!--widgetcontent--> </div><!--widget--></div><div style=\"height: 20px;\"></div>";
...
include ("./includes/dati_form_prenotazione.php");
echo "
<input class=\"input type=\"text\" class=\"form-control input-sm\"\" type=\"submit\" name=\"spezza_senza_app_agenzia\" value=\"".mex("Spezza la prenotazione in",$pag)." $n_tronchi ".mex("parti",$pag)."\"><br>
</div></form>";
} # fine if ($n_tronchi > 1)
} # fine if ($spezzetta == "occ_app_agenzia" or $num_app_agenzia == 0)
...
<input type=\"hidden\" name=\"id_prenota\" value=\"$idprenota\">
<input type=\"hidden\" name=\"origine\" value=\"inizio.php\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"vai\" value=\"".mex("Modifica la prenotazione",$pag)." $idprenota\">
</div></form></div>
<hr style=\"width: 95%\">";
...
<input type=\"hidden\" name=\"origine\" value=\"inizio.php\">
<input type=\"hidden\" name=\"id_prenota\" value=\"$lista_idprenota\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"vedi_contr\" value=\"".mex("Modifica come gruppo le prenotazioni inserite",$pag)."\">
</div></form></div><br>
<hr style=\"width: 95%\">";
} # fine if (str_replace(",","",$lista_idprenota) != $lista_idprenota)
if ($idmessaggi) {
...
echo "<br><div style=\"text-align: center;\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"ok\" value=\"".mex("Inserisci una nuova prenotazione",$pag)."\"></div>
<br></div></form>
<form accept-charset=\"utf-8\" method=\"post\" action=\"inizio.php\"><div style=\"text-align: center;\">
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"torna\" value=\"".mex("Torna al menù principale",$pag)."\">
<br></div></form><div style=\"height: 20px;\"></div>";
} # fine else if ($torna_invece_di_ok == "SI")
...
echo "
                        <div class=\"form-group\">
                            <label for=\"cognome\" class=\"col-md-2 control-label\">".mex("Cliente titolare: cognome",$pag)."</label>
                            <div class=\"col-md-10\">
                                <input type=\"text\" class=\"form-control input-default\" name=\"cognome\" value=\"$cognome\" id=\"cognome\" placeholder=".mex("Cliente titolare: cognome",$pag).">
                            </div>
                        </div>
";
if ($attiva_prefisso_clienti == "s") echo $prefisso_clienti." ";
echo "
                       <div class=\"form-group\">
                            <label for=\"nome\" class=\"col-md-2 control-label\">".mex("nome",$pag)."</label>
                            <div class=\"col-md-10\">
                                <input type=\"text\" class=\"form-control input-default\" name=\"nome\" value=\"$nome\" id=\"nome\" placeholder=".mex("nome",$pag).">
                            </div>
                        </div>
";
if ($prenota_vicine == "SI") $checked = " checked";
...
<div class=\"col-md-2\">
<select name=\"nometipotariffa$n_t\" class=\"form-control input-default\">
<option value=\"\"$sel>----</option>";
$num_tariffe = 0;
for ($numtariffa = 1 ; $numtariffa <= $dati_tariffe['num'] ; $numtariffa++) if ($attiva_tariffe_consentite == "n" or $tariffe_consentite_vett[$numtariffa] == "SI") $num_tariffe++;
for ($numtariffa = 1 ; $numtariffa <= $dati_tariffe['num'] ; $numtariffa++) {
...
<div class=\"col-md-3\">
<input type=\"text\" class=\"form-control input-default\" placeholder=\".col-md-3\">
</div>
</div
 </div>
</div>
...
<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr><td>jfkjfjkf
...
<input type=\"hidden\" name=\"mos_tut_dat\" value=\"$mos_tut_dat\">
<input type=\"hidden\" name=\"nuovaprenotazione\" value=\"SI\">
<input class=\"btn btn-primary\" id=\"inse\" type=\"submit\" name=\"ins_nuova_prenota\" value=\"".mex("Inserisci la prenotazione",$pag)."\">
<hr style=\"width: 95%\">
</div></div></form><br>
<form accept-charset=\"utf-8\" method=\"post\" action=\"inizio.php\"><div style=\"text-align: center;\">
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" id=\"indi\" type=\"submit\" name=\"torna\" value=\"".mex("Torna al menù principale",$pag)."\">
<br></div></form></div><!--widgetcontent--> </div><!--widget--><div style=\"height: 20px;\"></div>";
