...
<tr style=\"background-color: ".rowbgcolor().";\"><td>".ucfirst(mex("tipo",$pag)).": <b>$d_tipo_cc</b></td>
<td>".mex("cambia in",$pag).": 
<input type=\"text\" name=\"n_tipo_cc\" size=\"16\"></td></tr>
<tr style=\"background-color: ".rowbgcolor().";\"><td>".ucfirst(mex("numero",$pag)).": <b>$d_num_cc</b></td>
<td>".mex("cambia in",$pag).": 
<input type=\"text\" name=\"n_num_cc\" size=\"20\"></td></tr>
<tr style=\"background-color: ".rowbgcolor().";\"><td>".ucfirst(mex("titolare",$pag)).": <b>$d_nome_cc</b></td>
<td>".mex("cambia in",$pag).": 
<input type=\"text\" name=\"n_nome_cc\" size=\"28\"></td></tr>";

if (date("Ymd",(time() + (C_DIFF_ORE * 3600))) <= str_replace("-","",$d_scad_cc)) echo "<tr style=\"background-color: ".rowbgcolor().";\"><td>".ucfirst(mex("scadenza",$pag)).": <b>$d_scad_cc_f</b></td>";
else echo "<tr style=\"background-color: ".rowbgcolor().";\"><td>".ucfirst(mex("scadenza",$pag)).": <b class=\"colred\">$d_scad_cc_f</b></td>";
