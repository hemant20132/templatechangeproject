...
<input class=\"btn btn-primary\" type=\"submit\" name=\"gia_stato\" value=\"  ".mex("SI",$pag)."  \"></div></form><br>";
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"ok\" value=\"".mex("Torna indietro",$pag)."\">";
...
echo "<div class=\"widgetbox\"><h4 class=\"widgettitle\">"
.mex("Inserisci le regole di assegnazione per le prenotazioni dell'anno",$pag)."$anno </h4>
...
<span class=\"field\">
<select  class=\"uniformselect\" name=\"chiudi_app\">
<option value=\"1\" selected>".mex("Chiudi",$pag)."</option>
<option value=\"\">".mex("Chiedi prima di assegnare",$pag)."</option>
</select>
</span>

 ".mex("l'appartamento",'unit.php')."<span class=\"field\">
<select class=\"uniformselect\" name=\"appartamento\" >
<option value=\"\" selected>--</option>";
include(C_DATI_PATH."/selectappartamenti.php");
echo "</select></span> " .mex("nel periodo dal",$pag)." ";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"regola_1\" value=\"".mex("Inserisci la regola",$pag)." 1\">
</div></div></form>
...
".mex("Chiudi",$pag)."<span class=\"field\" > <select class=\"uniformselect\" name=\"tipotariffa\" id=\"t1\">
<option value=\"\" selected>----</option>";
...
mostra_menu_date(C_DATI_PATH."/selectperiodi$anno.$id_utente.php","fineperiodo",$fine_select,"","",$id_utente,$tema);
echo "<br>".mex("motivazione",$pag).":
 <input type=\"text\" class=\"form-control input-sm\" name=\"motivazione\" size=\"30\" maxlength=\"30\">
 (".mex("opzionale",$pag).")
 <input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Inserisci la regola",$pag)." 1 ".mex("per le tariffe",$pag)."\">
</div></form>
<hr style=\"width: 50%; margin-left: 2.5%;\">
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"inserisci\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"canc_regola_1\" value=\"".mex("Cancella tutte le regole di questo tipo",$pag)."\">
</div></form>
...
<span class=\"field\">
<select id=\"maxocc'+nreg+'\" class=\"uniformselect\" onchange=\"sel_app_maxocc(\\''+nreg+'\\')\">\
<option value=\"\" selected>-<\/option>\
";
ksort($lista_maxocc);
reset($lista_maxocc);
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Inserisci o modifica la regola",$pag)." 2\">
</div></div></form>
...
echo "</select>
 ...
 ".mex("giorni",$pag)."
<span class=\"field\"> 
<select id=\"if2b\" class=\"uniformselect\" name=\"ini_fine\">
<option value=\"ini\">".mex("dall'inizio",$pag)."</option>
<option value=\"fine\">".mex("dalla fine",$pag)."</option>
</select></span> ".mex("della prenotazione quando essa viene inserita, allora",$pag)."
 ".mex("assegna automaticamente gli appartamenti",'unit.php')."
...
echo "<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Inserisci o modifica questa eccezione alla regola",$pag)." 2\">
<script type=\"text/javascript\">
<!--
var txt_box = document.getElementById(\"v2b\");
txt_box.disabled = true;
...
<span class=\"field\">
<select name=\"tipotariffa\" class=\"uniformselect\" id=\"t3\" onchange=\"aggiorna_val_reg3()\">
<option value=\"\" selected>----</option>";
for ($numtariffa = 1 ; $numtariffa <= $numero_tariffe ; $numtariffa = $numtariffa + 1) {
$tariffa = "tariffa".$numtariffa;
$tariffa_vedi = mex("tariffa","prenota.php").$numtariffa;
...
<span class=\"field\">
<select id=\"v3\" class=\"uniformselect\" name=\"id_utente_inserimento\">
<option value=\"\" selected>----</option>
...
<div style=\"text-align: center;\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"regola_3\" value=\"".mex("Inserisci o modifica la regola",$pag)." 3\">
...
".mex("Quando si sceglie la tariffa",$pag)."
<span class=\"field\">
<select class=\"uniformselect\" name=\"tipotariffa\" id=\"t4\" onchange=\"aggiorna_val_reg4()\">
<option value=\"\" selected>----</option>";
for ($numtariffa = 1 ; $numtariffa <= $numero_tariffe ; $numtariffa = $numtariffa + 1) {
$tariffa = "tariffa".$numtariffa;
$tariffa_vedi = mex("tariffa","prenota.php").$numtariffa;
...
<div style=\"text-align: center;\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"regola_4\" value=\"".mex("Inserisci o modifica la regola",$pag)." 4\">
</div></div></form><hr style=\"width: 95%\">";
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("inserisci",'creaprezzi.php')."\">.
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"visualizza\" value=\"".mex("Vedi le regole già inserite",$pag)."\">
</div></form><br>
