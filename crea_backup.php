...
<span class=\"field\">
<select name=\"N_PHPR_DB_TYPE\" class=\"uniformselect\">
...
<input type=\"text\"  class=\"form-control input-sm\" name=\"N_PHPR_DB_NAME\"><br>";
echo "".mex("Database già esistente",$pag)."?
<span class=\"field\">
<select name=\"database_esistente\" class=\"uniformselect\">
<option value=\"SI\">".mex("Si",$pag)."</option>
<option value=\"NO\" selected>".mex("No",$pag)."</option></select></span><small>
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"N_PHPR_DB_HOST\" value=\"localhost\"><br>";
if (!strcmp($HOTELD_DB_PORT,"")) echo "".mex("Numero della porta a cui collegarsi",$pag).": 
<input type=\"text\"  class=\" form-control input-sm\" name=\"N_PHPR_DB_PORT\" value=\"5432\">(".mex("Normalmete 5432 o 5433 per Postgresql o 3306 per Mysql",$pag).")<br>";
if (!$HOTELD_DB_USER) echo "".mex("Nome per l'autenticazione al database",$pag).": 
<input type=\"text\"  class=\" form-control input-sm\" name=\"N_PHPR_DB_USER\"><br>";
if (!strcmp($HOTELD_DB_PASS,"")) echo "".mex("Parola segreta per l'autenticazione al database",$pag).": 
<input type=\"text\"  class=\" form-control input-sm\" name=\"N_PHPR_DB_PASS\"><br>";
echo "".mex("Caricare la libreria dinamica \"pgsql.so\" o \"mysql.so\"",$pag)."?
<span class=\"field\">
<select name=\"N_PHPR_LOAD_EXT\" class=\"uniformselect\" >
<option value=\"SI\">".mex("Si",$pag)."</option>
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"tempdatabase\" value=\"template1\"><small>
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"N_PHPR_TAB_PRE\" maxlength=\"8\" size=\"9\"><small>
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"vai\" value=\"".mex("Continua",$pag)."\">
</div></div></form><br>";
...
echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"indietro\" value=\"".mex("Torna indietro",$pag)."\">
</div></form></div>";
...
<input type=\"hidden\" name=\"azione\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"crea_backup\" value=\"";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"salva_backup\" value=\"".mex("Guarda il file",$pag)."\">
...
<input type=\"hidden\" name=\"backup_contratti\" value=\"SI\">
<input type=\"hidden\" name=\"azione\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cancella_backup\" value=\"".mex("Cancella",$pag)."\">
...
<input type=\"hidden\" name=\"backup_contratti\" value=\"SI\">
<input type=\"hidden\" name=\"azione\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"copia_def_backup\" value=\"".ucfirst(mex("copia",$pag))."\">
 ".mex("il file di backup dai documenti predefiniti in",$pag)."

<span class=\"field\"> 
<select name=\"lingua\" class=\"uniformselect\">
...
<input type=\"hidden\" name=\"backup_contratti\" value=\"SI\">
<input type=\"hidden\" name=\"azione\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"upload_backup\" value=\"".mex("Fai l'upload",$pag)."\">";
...
<div class=\"checkbox\"><label><input type=\"checkbox\" name=\"compresso\" value=\"SI\" checked> ".mex("Compresso",$pag)."</label>
</div></td></tr></table></div></form><table><tr><td style=\"height: 4px;\"></td></tr></table>";
if ($file_esistente == "SI") {
...
<input type=\"hidden\" name=\"backup_contratti\" value=\"SI\">
<input type=\"hidden\" name=\"azione\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"ripristina_backup\" value=\"".mex("Ripristina i documenti dal file",$pag)."\"><br>
<table><tr><td style=\"width: 30px;\"></td><td>
<div class=\"radio btradio\">
<label>
<input type=\"radio\" name=\"modalita\" value=\"aggiungi\" checked>".mex("aggiungi ai documenti attuali",$pag)."</label></div>";

if ($info_contr['max_contr'] > 1) {
echo "<span class=\"field\">
<select name=\"contr_agg\" class=\"uniformselect\">
...
echo "<br>
<div class=\"radio btradio\">
<label><input type=\"radio\" name=\"modalita\" value=\"rimpiazza\">".mex("rimpiazza i documenti attuali",$pag)."</label> (".mex("i documenti attuali verranno cancellati",$pag).")</div><br>";
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"indietro\" value=\"".mex("Backup completo",$pag)."\">
</div></form><br>";
} # fine if ($backup_contratti == "SI")
...
else echo "<div class=\"widgetbox\">
<h4 class=\"widgettitle\">".mex("Sistema di backup per HotelDruid",$pag).".</h4>
...
<div onclick=\"document.getElementById('ab_sel').checked='1'\">
<div class=\"radio btradio\">
<label><input type=\"radio\" name=\"anni_backup\" id=\"ab_sel\" value=\"sel\">".mex("Includi solo gli anni selezionati",$pag)."</label></div>: ";

for ($num1 = 0 ; $num1 < $num_anni ; $num1++) {
$anno_corr = risul_query($anni,$num1,'idanni');
echo "<div class=\"checkbox\"><label><input type=\"checkbox\" name=\"anno_sel$anno_corr\" value=\"1\"> $anno_corr</label></div>";
if ($num1 != ($num_anni - 1)) echo "; ";
} # fine for $num1
echo "</div>";
} # fine if ($num_anni > 1)
echo "<div class=\"checkbox\"><label><input type=\"checkbox\" name=\"includi_modelli\" value=\"SI\" checked> ".mex("Includi i modelli internet",$pag)."</label></div>
...
<table><tr><td style=\"width: 30px;\"></td><td>
<div class=\"checkbox\"><label><input type=\"checkbox\" name=\"compresso\" value=\"SI\" checked> ".mex("Compresso",$pag)."</label></div>
</td></tr></table></div></form><table><tr><td style=\"height: 4px;\"></td></tr></table>";
#if ($id_utente == 1) {
echo "<form accept-charset=\"utf-8\" method=\"post\" action=\"./crea_backup.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
...
echo ".<br><table><tr><td style=\"width: 30px;\"></td><td>
<div class=\"checkbox\">
<label><input type=\"checkbox\" name=\"compresso\" value=\"SI\" checked> ".mex("Compresso",$pag)."</label></div>
</td></tr></table></div></form><table><tr><td style=\"height: 4px;\"></td></tr></table>";
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"azione\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"ripristina_backup\" value=\"".mex("Ripristina i dati dal file",$pag)."\">
".mex(" (i dati attuali verranno cancellati), utilizzando per la connessione al database:",$pag)."<br>
<table><tr><td style=\"width: 30px;\"></td><td>
<div>
<div class==\"radio btradio\">
<label><input type=\"radio\" name=\"dati_conn\" value=\"attuali\" checked>".mex("i dati dell'attuale connessione",$pag)."</label></div>";
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"backup_contratti\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"indietro\" value=\"".mex("Backup dei documenti",$pag)."\">
</div></form><br>";
