...
if ($luogo_da_trovato == "SI") echo "<br><input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Continua",$pag)."\">";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina\" value=\"".mex("SI",$pag)."\">
...
if ($tipoid == "idappartamento") echo "<div class=\"widgetbox\">
<h4 class=\"widgettitle\">".mex("Inventario dell'appartamento",'unit.php')."</h4>
<div class=\"widgetcontent\"> <b>$nome_mag</b>.</h3><br>";
else echo "<h4>".mex("Inventario del magazzino",$pag)." $nome_mag.</h4><br>";
echo "<form accept-charset=\"utf-8\" method=\"post\" action=\"$pag\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"origine\" value=\"$origine\">
...
<table class=\"table table-bordered responsive\" style=\" margin-left: auto; margin-right: auto;\" width=3 border=\"$t1border\" cellspacing=\"$t1cellspacing\" cellpadding=\"$t1cellpadding\">
...
if ($priv_mod_beni != "n") echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"modifica_quantita\" value=\"".mex("Modifica le quantità attuali",$pag)."\">";
