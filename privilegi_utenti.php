...
if ($nuovi_contratti_sel != substr($contratti_consentiti,2)) {
...
} # fine if ($nuovi_contratti_sel != substr($contratti_consentiti,2))
...
if ($seleziona_contratti == "n" or $seleziona_contratti == "s") $nuovi_contratti_consentiti = $seleziona_contratti.",".substr($nuovi_contratti_consentiti,2);
if ($cambia_contratti_sel) $nuovi_contratti_consentiti = substr($nuovi_contratti_consentiti,0,2).$nuovi_contratti_sel;
