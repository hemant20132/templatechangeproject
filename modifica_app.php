...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cancella_app\" value=\"".mex("SI",$pag)."\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"non_cancellare\" value=\"".mex("NO",$pag)."\">
<br></div></form>";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"modificaappartamento_vedi\" value=\"".mex("Continua",$pag)."\">
<hr style=\"width: 95%\">
</div></form>";
} # fine if ($modificaappartamento != "Continua")
...
<input type=\"hidden\" name=\"tipo_tabella\" value=\"appartamenti\">
<input type=\"hidden\" name=\"idappartamenti\" value=\"$idappartamenti\">";
echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"torna\" value=\"".mex("Torna indietro",$pag)."\">
<br></div></form><br></div>";
...
<h4 class=\"widgettitle\">" .mex($fr1."Modifica l'appartamento",'unit.php'). "$idappartamenti.</h4>
...
<td>".mex("Cambia in",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"n_nome_app0\" size=\"10\"></td></tr>
<tr><td>".mex("Casa",$pag).": <b>$d_numcasa</b></td>
<td>".mex("Cambia in",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"n_numcasa0\" size=\"10\"></td></tr>
<tr><td>".mex("Piano",$pag).": <b>$d_numpiano</b></td>
<td>".mex("Cambia in",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"n_numpiano0\" size=\"10\" maxlength=\"10\"></td></tr>
<tr><td>".mex("Capienza",$pag).": <b>$d_maxoccupanti</b> ";
if ($d_maxoccupanti == 1) echo mex("Persona",$pag);
else echo mex("Persone",$pag);
echo "</td><td>";
if (!$d_letto) echo "".mex("Cambia in",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"n_maxoccupanti0\" size=\"2\" maxlength=\"2\">";
echo "</td></tr>
<tr><td>".mex("Priorità",$pag).": <b>$d_priorita</b></td>
<td>".mex("Cambia in",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"n_priorita0\" size=\"5\" maxlength=\"5\"></td></tr>
<tr><td>".mex($fr1."Appartamenti vicini",'unit.php').": </td>
<td> <input type=\"text\"  class=\" form-control input-sm\" name=\"n_app_vicini0\" size=\"25\" value=\"$d_app_vicini\"> (".mex($fr1."lista di appartamenti separati da virgole",'unit.php').")</td></tr>
</table>
".mex("Commento",$pag).":<br>

<textarea name=\"n_commento0\"  class=\"form-control input-default\" rows=3 cols=60 style=\"white-space: pre; overflow: auto;\">$d_commento</textarea><br>
...
<input class=\"btn btn-primary\" id=\"modi\" type=\"submit\" name=\"modificaappartamento\" value=\"".mex($fr1."Modifica l'appartamento",'unit.php')." $idappartamenti\">
...
<textarea name=\"n_descrizione_ita\" class=\"form-control input-default\" rows=4 cols=60 style=\"white-space: pre; overflow: auto;\">$d_descrizione</textarea></td>";
$col = 0;
$max_col = 2;
unset($lingue_vett);
$lang_dir = opendir("./includes/lang/");
...
echo "<textarea name=\"n_descrizione_$ini_lingua\" class=\"form-control input-default\" rows=4 cols=60 style=\"white-space: pre; overflow: auto;\">$d_descrizione</textarea></td>";
} # fine if ($file != "." && $file != ".." and...
} # fine while ($file = readdir($lang_dig))
closedir($lang_dir);
echo "</tr></table>
<input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("modifica",$pag))."\"></div></form><br><br>";
...
if ($priv_mod_tariffe != "n") echo "Italiano: <input type=\"text\"  class=\" form-control input-sm\" name=\"n_commento_ita\" value=\"$d_commento\" size=\"24\"><br>";
...
echo "".ucfirst($nome_lingua).": <input type=\"text\"  class=\" form-control input-sm\" name=\"n_commento_$ini_lingua\" value=\"$d_commento\" size=\"24\"><br>";
} # fine while (list($ini_lingua,$nome_lingua) = each($lingue_vett))
echo "<input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("modifica",$pag))."\">
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"n_urlfoto\" size=\"30\" value=\"http://\"$readonly>
<input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("aggiungi",$pag))."\">
</div></form>";
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"idappartamenti\" value=\"$idappartamenti\">
<input class=\"btn btn-primary\" id=\"canc\" type=\"submit\" name=\"cancella_app\" value=\"".mex($fr1."Cancella l'appartamento",'unit.php')." $idappartamenti\">
</div><br></form></div>
