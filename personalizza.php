...
<select name=\"salta_a\" class=\"smallsel\">$opt_su</select>
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Applica i cambiamenti",$pag)."\">
</div></form><br><br>";
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("attiva la password",$pag))."\">
</div></form><br><br>";
} # fine if (!$n_pass_cc)
else {
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("continua",$pag))."\">
</div></form><br><br>";
} # fine if (!$continua)
else {
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Cancella tutti i log",$pag)."\">&nbsp;&nbsp;&nbsp;
</div></form><br>
...
echo "? <input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("SI",$pag)."\">
</div></form><br><br>";
} # fine if (!$continua)
...
if (preg_match('/^[_\.0-9a-z-]+@([0-9a-z][0-9a-z-]+\.)+[a-z]{2,4}$/i',$n_email)) {
if (get_magic_quotes_gpc()) {
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("SI",$pag)."\">
</div></form><br><br><br>";
$torna_invece_di_ok = "SI";
...
{ echo "<div class=\"widgetbox\">
        <h4 class=\"widgettitle\"> ".mex("Configura e personalizza HotelDruid",$pag)."  </h4>
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"vai_a_u\" value=\"".mex("Gestione utenti",$pag)."\">
</div></form></td>
<td align=\"center\"><form accept-charset=\"utf-8\" method=\"post\" action=\"./crea_modelli.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"vai_a_m\" value=\"".mex("Pagine per il sito web",$pag)."\">
</div></form></td>";
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"vai_a_i\" value=\"".mex("Interconnessioni",$pag)."\">
</div></form></td>";
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"vai_a_b\" value=\"".mex("Sistema di backup",$pag)."\">
</div></form></td>";
} # fine if ($installazione_subordinata != "SI")
...
echo mex("Cambia il numero delle tariffe",$pag)." ".mex("per l'anno",$pag)." $anno
 ".mex("a",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"nuovo_numero_tariffe\" size=\"5\" value=\"$numerotariffe\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambianumerotariffe\" value=\"".mex("Cambia",$pag)."\">
...
<input type=\"hidden\" name=\"aggiorna_qualcosa\" value=\"SI\">
<input type=\"hidden\" name=\"cambia_ord_tariffe\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("cambia l'ordine delle tariffe",$pag))."\">
...
".mex("Crea un nuovo appartamento",'unit.php')."
 n° <input type=\"text\" class=\"form-control input-sm\"  name=\"n_app\" size=\"7\" maxlength=\"45\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"crea_app\" value=\"".mex("aggiungi",$pag)."\">
...
".mex("Creare","visualizza_tabelle.php")." <input type=\"text\" class=\"form-control input-sm\" name=\"n_letti\" size=\"2\" maxlength=\"3\" value=\"4\">
".mex("[1]appartamenti",'unit.php')." ".mex("nel nuovo appartamento",'unit.php')."
 n° <input type=\"text\" class=\"form-control input-sm\" name=\"n_app\" size=\"5\" maxlength=\"45\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("aggiungi",$pag)."\">
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"attiva_pass_cc\" value=\"".mex("Attiva",$pag)."\">";
} # fine if (!numlin_query($cert_cc))
else {
echo ucfirst(mex("password per la visualizzazione dei dati delle carte di credito",$pag))." ".mex("attivata",$pag)."
<input class=\"btn btn-primary\" type=\"submit\" name=\"disattiva_pass_cc\" value=\"".mex("Disattiva",$pag)."\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_pass_cc\" value=\"".ucfirst(mex("cambia la password",$pag))."\">";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"attiva_assegnazione_automatica\" value=\"".mex("Attiva",$pag)."\">";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"disattiva_assegnazione_automatica\" value=\"".mex("Disattiva",$pag)."\">";
...
".mex("Secondi dopo i quali abbandonare la ricerca di un appartamento libero",'unit.php').":
 <input type=\"text\" class=\"form-control input-sm\" name=\"secondi_lim_liberasett\" value=\"$tutti_fissi\" size=\"4\" maxlength=\"4\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_secondi_lim_liberasett\" value=\"".mex("cambia",$pag)."\">
</td></tr></table>";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"attiva_auto_crea_anno\" value=\"".mex("Attiva",$pag)."\">";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"disattiva_auto_crea_anno\" value=\"".mex("Disattiva",$pag)."\">";
...
$option_select_gruppi_log
 ...
 <input class=\"btn btn-primary\" type=\"submit\" name=\"attiva_phpr_log\" value=\"".mex("Attiva",$pag)."\">";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"disattiva_phpr_log\" value=\"".mex("Disattiva",$pag)."\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input class=\"btn btn-primary\" type=\"submit\" name=\"vedi_log\" value=\"".mex("Vedi i log",$pag)."\">";
...
<input type=\"text\" class=\"form-control input-sm\" name=\"minuti_durata_sessione\" value=\"$minuti_durata_sessione\" size=\"4\" maxlength=\"4\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_minuti_durata_sessione\" value=\"".mex("cambia",$pag)."\">
</div></form></td></tr><tr><td style=\"height: 5px;\"></td></tr><tr><td>
<form accept-charset=\"utf-8\" method=\"post\" action=\"./personalizza.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
...
echo mex("Minuti durante i quali mantenere gli appartamenti occupati mentre si sta inserendo una prenotazione",'unit.php').":
 <input type=\"text\"  class=\"form-control input-sm\" name=\"minuti_durata_insprenota\" value=\"$minuti_durata_insprenota\" size=\"4\" maxlength=\"4\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_minuti_durata_insprenota\" value=\"".mex("cambia",$pag)."\">
</div></form></td></tr></table>
<hr style=\"width: 95%\">
...
echo "</select>
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_ore_diff_server\" value=\"".mex("cambia",$pag)."\">
</div></form></td></tr><tr><td style=\"height: 5px;\"></td></tr><tr><td>";
...
echo mex("Cartelle in cui creare le pagine per il sito web",$pag).":
 <input type=\"text\" class=\"form-control input-sm\" name=\"percorso_cartella_modello\" value=\"$percorso_cartella_modello\" size=\"20\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_percorso_cartella_modello\" value=\"".mex("cambia",$pag)."\">
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_maschera_email\" value=\"".mex("cambia",$pag)."\">
</div></form>";
...
$trad_lingue = "Italiano:
 ".mex("singolare",$pag)." <input class=\"form-control input-sm\" type=\"text\" name=\"trad_s_n_ita\" size=\"12\" value=\"".$unit['lang']['ita']['s_n']."\">;
 ".mex("plurale",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"trad_p_n_ita\" size=\"12\" value=\"".$unit['lang']['ita']['p_n']."\">;
 ".mex("genere",$pag)." 
 
<span class=\"field\">
<select name=\"trad_gender_ita\" class=\"uniformselect\">
...
$linea_lingua = ucfirst($nome_lingua).":
 ".mex("singolare",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"trad_s_n_$ini_lingua\" size=\"12\" value=\"".$unit['lang'][$ini_lingua]['s_n']."\">;
 ".mex("plurale",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"trad_p_n_$ini_lingua\" size=\"12\" value=\"".$unit['lang'][$ini_lingua]['p_n']."\">;
 ".mex("genere",$pag)."
<span class=\"field\">
<select name=\"trad_gender_$ini_lingua\">
<option value=\"m\"$sel_m>".mex("m",$pag)."</option>
<option value=\"f\"$sel_f>".mex("f",$pag)."</option>
</select></span>.<br>";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_nome_unita\" value=\"".mex("Cambia",$pag)."\"></div>";
} # fine if ($sel_pers)
else echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_nome_unita\" value=\"".mex("Cambia",$pag)."\">";
echo "</div></form></td></tr>";
...
$trad_lingue = "Italiano:
 ".mex("singolare",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"trad_s_n_ita\" size=\"12\" value=\"".$unit['lang']['ita']['s_n']."\">;
 ".mex("plurale",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"trad_p_n_ita\" size=\"12\" value=\"".$unit['lang']['ita']['p_n']."\">;
 ".mex("genere",$pag)."
<span class=\"field\">
<select class=\"uniformselect\" name=\"trad_gender_ita\">
<option value=\"m\"$sel_m>".mex("m",$pag)."</option>
<option value=\"f\"$sel_f>".mex("f",$pag)."</option>
</select></span>.<br>";
...
$linea_lingua = ucfirst($nome_lingua).":
 ...
 ".mex("singolare",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"trad_s_n_$ini_lingua\" size=\"12\" value=\"".$unit['lang'][$ini_lingua]['s_n']."\">;
 ".mex("plurale",$pag)." <input type=\"text\" class=\"form-control input-sm\"  name=\"trad_p_n_$ini_lingua\" size=\"12\" value=\"".$unit['lang'][$ini_lingua]['p_n']."\">;
 ".mex("genere",$pag)." <span class=\"field\"> <select class=\"uniformselect\" name=\"trad_gender_$ini_lingua\">
<option value=\"m\"$sel_m>".mex("m",$pag)."</option>
<option value=\"f\"$sel_f>".mex("f",$pag)."</option>
</select></span>.<br>";
if ($ini_lingua == $lingua[$id_utente]) $trad_lingue = $linea_lingua.$trad_lingue;
...
closedir($lang_dir);
echo "<div style=\"line-height: 1.5em;\">$trad_lingue</div><div style=\"text-align: right; padding: 5px 0 0 0;\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_nome_unita_sing\" value=\"".mex("Cambia",$pag)."\"></div>";
} # fine if ($sel_pers)
else echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_nome_unita_sing\" value=\"".mex("Cambia",$pag)."\">";
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"parola_da_elininare\">";
$file_sost = @file(C_DATI_PATH."/parole_sost.php");
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_parola_da_sostituire\" value=\"".mex("elimina",$pag)."\">
...
<input class=\"form-input input-sm\" type=\"text\" name=\"vecchia_parola\" size=\"12\" value=\"\"> 
".mex("con",$pag)." <input type=\"text\" class=\"form-input input-sm\" name=\"nuova_parola\" size=\"12\" value=\"\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_parola_da_sostituire\" value=\"".mex("aggiungi",$pag)."\">
</div></form><hr style=\"width: 95%\">";
...
<span class=\"field\">
<select name=\"id_utente_mod\" class=\"uniformselect\">
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_ut\" value=\"".mex("Cambia",$pag)."\">
...
<span class=\"field\"> 
<select name=\"n_lingua\" class=\"uniformselect\">
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambialingua\" value=\"".mex("cambia la lingua",$pag)."\"><br>
</div></form><hr style=\"width: 95%\">
...
<span class=\"field\">
<select name=\"nuovo_tema\" class=\"uniformselect\">
...
closedir($temi_dir);
echo "</select></span>
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambiatema\" value=\"".mex("cambia",$pag)."\"><br>
</div></form><hr style=\"width: 95%\">";
...
echo mex("Cambia la valuta",$pag)."
 ".mex("a",$pag)."<input type=\"text\" class=\"form-control input-sm\" name=\"nuova_valuta\" size=\"8\" value=\"$Euro_utente\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambiavaluta\" value=\"".mex("Cambia",$pag)."\">
</div></form><div style=\"height: 5px;\"></div>
...
echo ucfirst(mex("valore predefinito a cui arrotondare le percentuali dei prezzi",$pag)).":
 <input type=\"text\" class=\"form-control input-sm\" name=\"nuovo_arrotond\" size=\"4\" value=\"$arrotond_predef\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambiaarrotonda\" value=\"".mex("Cambia",$pag)."\">
</div></form><div style=\"height: 5px;\"></div>
...
echo ucfirst(mex("valore a cui arrotondare le percentuali delle tasse",$pag)).":
 <input type=\"text\" class=\"form-control input-sm\" name=\"nuovo_arrotond_tasse\" size=\"4\" value=\"$arrotond_tasse\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Cambia",$pag)."\">
</div></form><hr style=\"width: 95%\">
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_formato_soldi\" value=\"".mex("cambia formato",$pag)."\">
</td></tr></table>
</div></form><hr style=\"width: 95%\">
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_formato_data\" value=\"".mex("cambia formato",$pag)."\">
</td></tr></table>
</div></form><hr style=\"width: 95%\">
...
echo mex("Numero di ore di cui anticipare il momento in cui si considera iniziata una prenotazione",$pag).":
 ...
 <input type=\"text\" class=\"form-control input-sm\" name=\"ore_anticipa_periodo_corrente\" value=\"$ore_anticipa_periodo_corrente\" size=\"3\" maxlength=\"3\">

 <input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_ore_anticipa_periodo_corrente\" value=\"".mex("cambia",$pag)."\">
</div></form><hr style=\"width: 95%\">
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"disattiva_checkin\" value=\"".mex("Disattiva",$pag)."\">";
} # fine if ($attiva_checkin == "SI")
else {
echo mex("Registrazione degli orari di entrata ed uscita disattivata",$pag)."
<input class=\"btn btn-primary\" type=\"submit\" name=\"attiva_checkin\" value=\"".mex("Attiva",$pag)."\">";
...
if ($metodi_pagamento) {
echo "<span class=\"field\" > <select class=\"uniformselect\" name=\"metodo_da_eliminare\">";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_pagamento\" value=\"".mex("elimina",$pag)."\">&nbsp;&nbsp;&nbsp;";
} # fine if ($metodi_pagamento)
echo " <input type=\"text\" class=\"form-control input-sm\" name=\"nuovo_metodo_pagamento\" size=\"20\" maxlength=\"50\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_pagamento\" value=\"".mex("aggiungi",$pag)."\">
</div></form><hr style=\"width: 95%\">
...
if ($origini_prenota) {
echo "<span class=\"field\"><select class=\"uniformselect\" name=\"origine_da_eliminare\">";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_origine\" value=\"".mex("elimina",$pag)."\">&nbsp;&nbsp;&nbsp;";
} # fine if ($origini_prenota)
echo " <input type=\"text\" name=\"nuova_origine_prenota\" size=\"20\" maxlength=\"50\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_origine\" value=\"".mex("aggiungi",$pag)."\">
</div></form><hr style=\"width: 95%\">
...
if ($comb_app) {
echo "<span class=\"field\"> <select class=\"uniformselect\" name=\"comb_app_da_eliminare\">";
...
echo "</select></span>
<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_comb_app\" value=\"".mex("elimina",$pag)."\">";
} # fine if ($comb_app)

echo "<br>" .mex("Nome combinazione",$pag). ": <input type=\"text\" class=\"form-control input-sm\" name=\"n_nome_comb_app\" size=\"18\" maxlength=\"50\">
".mex("lista appartamenti",'unit.php').": <input type=\"text\"  class=\"form-control input-sm\" name=\"n_comb_app\" size=\"25\">
(".mex("separati da virgole",'unit.php').")
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_comb_app\" value=\"".mex("aggiungi",$pag)."\">
</div></form></div><hr style=\"width: 95%\">
...
if ($titoli_cliente) {
echo "<span class=\"field\"><select  class=\"uniformselect\" name=\"titolo_da_eliminare\">";
...
echo "</select></span>
<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_titolo\" value=\"".mex("elimina",$pag)."\">&nbsp;&nbsp;&nbsp;";
} # fine if ($titoli_cliente)
echo " <input type=\"text\" class=\"form-control input-sm\" name=\"nuovo_titolo_cliente\" size=\"12\" maxlength=\"30\">
 (".mex("sesso",$pag)." <select  class=\"uniformselect\" name=\"sesso_titolo\">
<option value=\"\" selected>-</option>
<option value=\"m\">".mex("m",$pag)."</option>
<option value=\"f\">".mex("f",$pag)."</option>
</select></span> )
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_titolo\" value=\"".mex("aggiungi",$pag)."\">
</div></form><hr style=\"width: 95%\">
...
echo "<span class=\"field\"> <select class=\"uniformselect\" name=\"campo_da_eliminare\">";
...
echo "</select></span>
<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_campo_pers_cliente\" value=\"".mex("elimina",$pag)."\">&nbsp;&nbsp;&nbsp;";
} # fine if ($campi_pers_cliente)
echo " <input type=\"text\" class=\"form-control input-sm\" name=\"nuovo_campo_cliente\" size=\"12\" maxlength=\"30\">
 (".mex("tipo",$pag)."<span class=\"field\">
<select class=\"uniformselect\" name=\"tipo_campo\">
<option value=\"bool\" selected>".mex("booleano",$pag)."</option>
<option value=\"txt\">".mex("testo",$pag)."</option>
</select></span>)
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_campo_pers_cliente\" value=\"".mex("aggiungi",$pag)."\">
</div></form><hr style=\"width: 95%\">";
...
echo mex(ucfirst($nome_plur),$pag)." ".mex($frase_nella_sup,$pag)."
 ...
 <span class=\"field\"><select class=\"uniformselect\" id=\"$rel_sup_sing"."_$rel_sing\" onchange=\"ricarica_ifrm('dati_rel','$rel_sing"."_da_eliminare','$rel_sup_sing"."_$rel_sing','$rel_sing','$rel_sup_sing','$id_utente_sel')\">
<option value=\"\" selected>----</option>
$opt_rel_sup
</select></span>:
...
if ($num_rel_utente) {
echo "<span class=\"field\"><select class=\"uniformselect\" name=\"$rel_sing"."_da_eliminare\" id=\"$rel_sing"."_da_eliminare\">";
...
else echo "<input type=\"text\" class=\"form-control input-sm\" name=\"$rel_sing"."_da_eliminare\" id=\"$rel_sing"."_da_eliminare\" size=\"20\" maxlength=\"50\">";
echo "</b>";
} # fine if ($opt_rel_sup)
...
<span class=\"field\">
<select name=\"$rel_sing"."_da_eliminare\" class=\"uniformselect\" >";
for ($num1 = 0 ; $num1 < $num_rel_utente ; $num1++) {
$rel = htmlspecialchars(risul_query($rel_utente,$num1,"nome_$rel_sing",$tablerel));
$codice = htmlspecialchars(risul_query($rel_utente,$num1,"codice_$rel_sing",$tablerel));
$codice2 = htmlspecialchars(risul_query($rel_utente,$num1,"codice2_$rel_sing",$tablerel));
...
echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_$rel_sing\" value=\"".mex("elimina",$pag)."\">";
if ($mostra_sup != "SI") echo "&nbsp;&nbsp;&nbsp;<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_tutte_$rel_plur\" value=\"".mex("Elimina tutt$e",$pag)."\">";
echo "<br>";
} # fine if ($mostra_linea_canc == "SI")

echo "<table cellspacing=0 cellpadding=0 style=\"margin: 4px 0 4px 0;\"><tr><td>
".mex("Nuov$a $nome_sing",$pag).": <input type=\"text\" class=\"form-control input-sm\" name=\"nuova_$rel_sing\" size=\"20\" maxlength=\"50\"> (";
if ($opt_rel_sup) {
echo "".mex($frase_nella_sup,$pag)."
<span class=\"field\" class=\"uniformselect\"> 
<select name=\"sup_n_$rel_sing\">
<option value=\"\" selected>----</option>
$opt_rel_sup
</select></span>,<br>";
} # fine if ($opt_rel_sup)
echo mex("codice",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"cod_n_$rel_sing\" size=\"12\" maxlength=\"50\">,";
if (!$opt_rel_sup) echo "<br>";
else echo " ";
echo "".mex("2° codice",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"cod2_n_$rel_sing\" size=\"12\" maxlength=\"50\">,
 ".mex("3° codice",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"cod3_n_$rel_sing\" size=\"12\" maxlength=\"50\">)
</td><td style=\"width: 10px;\"></td><td valign=\"middle\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_$rel_sing\" value=\"".mex("aggiungi",$pag)."\">
</td></tr></table>";
if ($id_utente == 1 and $option_select_utenti_importa_contratti) {
echo "".mex("Importa $le $nome_plur",$pag)."
 ".mex("dell'utente",$pag)."
 <span class=\"field\">
 <select class=\"uniformselect\" name=\"utente_importa_$rel_plur\">
$option_select_utenti_importa_contratti
</select>
</span>

<input class=\"btn btn-primary\" type=\"submit\" name=\"importa_$rel_plur\" value=\"".mex("Importa",$pag)."\">&nbsp;&nbsp;&nbsp;";
} # fine if ($id_utente == 1 and $option_select_utenti_importa_contratti)
echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"$rel_plur"."_predefinite\" value=\"".mex("Ripristina predefinit$e",$pag)."\">";
if ($mostra_linea_canc == "SI" and $mostra_sup == "SI") echo "&nbsp;&nbsp;&nbsp;<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_tutte_$rel_plur\" value=\"".mex("Elimina tutt$e",$pag)."\">";
echo "</div></form></div>
<hr style=\"width: 95%\">";
...
echo mex("Nome",$pag).":
 ...
 <input class=\"form-control input-sm\" type=\"text\"$readonly name=\"nuovo_nome_strutt\" size=\"32\" value=\"".$dati_strut[0]."\">
</td><td style=\"width: 50px;\"></td><td>
".mex("Tipo",$pag).":
 <input class=\"form-control input-sm\" type=\"text\"$readonly name=\"nuovo_tipo_strutt\" size=\"32\" value=\"".$dati_strut[1]."\">
</td></tr><tr><td>
".mex("Indirizzo email",$pag).":
 <input class=\"form-control input-sm\" type=\"text\"$readonly name=\"nuova_email\" size=\"32\" value=\"".$dati_strut[2]."\">
</td><td style=\"width: 50px;\"></td><td>
".mex("Ragione sociale",$pag).":
 <input class=\"form-control input-sm\" type=\"text\"$readonly name=\"nuova_rag_sociale_strutt\" size=\"32\" value=\"".$dati_strut[3]."\">
</td></tr><tr><td>
".mex("Sito web",$pag).":
 <input  class=\"form-control input-sm\" type=\"text\"$readonly name=\"nuovo_sito_web_strutt\" size=\"32\" value=\"".$dati_strut[4]."\">
</td><td style=\"width: 50px;\"></td><td>
".mex("Nome contatto",$pag).":
 <input type=\"text\"$readonly class=\"form-control input-sm\" name=\"nuovo_nome_contatto_strutt\" size=\"32\" value=\"".$dati_strut[5]."\">
</td></tr><tr><td>
".mex("Nazione",$pag).":
 <input type=\"text\"$readonly class=\"form-control input-sm\" name=\"nuova_nazione_strutt\" size=\"32\" value=\"".$dati_strut[6]."\">
</td><td style=\"width: 50px;\"></td><td>
".mex("Comune",$pag).":
 <input type=\"text\"$readonly class=\"form-control input-sm\" name=\"nuovo_comune_strutt\" size=\"32\" value=\"".$dati_strut[7]."\">
</td></tr><tr><td>
".mex("Indirizzo",$pag).":
 <input type=\"text\"$readonly class=\"form-contorl input-sm\" name=\"nuovo_indirizzo_strutt\" size=\"32\" value=\"".$dati_strut[8]."\">
</td><td style=\"width: 50px;\"></td><td>
".mex("CAP",$pag).":
 <input type=\"text\"$readonly name=\"nuovo_cap_strutt\" class=\"form-control input-sm\" size=\"32\" value=\"".$dati_strut[9]."\">
</td></tr><tr><td>
".mex("Telefono",$pag).":
 <input type=\"text\"$readonly name=\"nuovo_telefono_strutt\" class=\"form-control input-sm\" size=\"32\" value=\"".$dati_strut[10]."\">
</td><td style=\"width: 50px;\"></td><td>
".mex("Fax",$pag).":
 <input type=\"text\"$readonly class=\"form-control input-sm\" name=\"nuovo_fax_strutt\" size=\"32\" value=\"".$dati_strut[11]."\">
</td></tr><tr><td>
".mex("Codice fiscale",$pag).":
 <input type=\"text\"$readonly class=\"form-control input-sm\" name=\"nuovo_cod_fiscale_strutt\" size=\"32\" value=\"".$dati_strut[12]."\">
</td><td style=\"width: 50px;\"></td><td>
".mex("Partita iva",$pag).":
 <input type=\"text\"$readonly class=\"form-control input-sm\" name=\"nuova_partita_iva_strutt\" size=\"32\" value=\"".$dati_strut[13]."\">
</td></tr><tr><td>
".mex("Numero stelle",$pag).":
 <input type=\"text\"$readonly  class=\"form-control input-sm\" name=\"nuovo_num_stelle_strutt\" size=\"32\" value=\"".$dati_strut[14]."\">
</td><td style=\"width: 50px;\"></td><td>
".mex("URL del logo",$pag).":
 <input type=\"text\"$readonly class=\"form-control input-sm\" name=\"nuovo_logo_strutt\" size=\"32\" value=\"".$dati_strut[15]."\">
</td></tr></table>
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambiadatistrut\" value=\"".mex("Modifica i dati della struttura",$pag)."\">
</div></form><hr style=\"width: 95%\">";
...
<span class=\"field\" > <select class=\"uniformselect\" name=\"giorno_vedi_ini_sett\">
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambiainisett\" value=\"".mex("Cambia",$pag)."\">
</div></form><table><tr><td style=\"height: 5px;\"></td></tr></table>";
...
<input type=\"text\" class=\"form-control input-sm\" name=\"intervalloperiodo$num1\" value=\"$val_intervalloperiodo\" size=\"2\" maxlength=\"2\"><br>";
} # fine for $num1
echo "</td><td style=\"width: 20px;\"></td><td valign=\"bottom\">";
if ($num_periodi_date > 1) echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"eliminadatemenu\" value=\"".mex("-",$pag)."\">&nbsp;";
echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungidatemenu\" value=\"".mex("+",$pag)."\">
</td></tr><tr><td colspan=\"3\"></td><td>
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambiadatemenu\" value=\"".mex("Cambia",$pag)."\">
</td></tr></table>
<input type=\"hidden\" class=\"form-control input-sm\" name=\"num_periodi_date\" value=\"$num_periodi_date\">
</div></form>";
...
<span class=\"field\"><select class=\"uniformselect\" name=\"mese_fine\">";
...
echo "</select></span>
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi\" value=\"".mex("aggiungi",$pag)."\"><br>";
echo "<small>(

<label>
<div class=\"checkbox\">
<label>
<input type=\"checkbox\" name=\"importa_prezzi\" value=\"SI\" style=\"width: 14px; height: 12px;\" checked>".mex("prova ad importare i prezzi","visualizza_tabelle.php").
"</label><div>";
                
if ($tipo_periodi == "g") {
echo ":<div class=\"radio btradio\">
<label><input type=\"radio\" name=\"tipo_importa\" value=\"giorn\" style=\"width: 14px; height: 12px;\" checked>".mex("giornalmente","visualizza_tabelle.php")."</label>
<label><input type=\"radio\" name=\"tipo_importa\" value=\"sett\" style=\"width: 14px; height: 12px;\">".mex("settimanalmente","visualizza_tabelle.php")."</label></div>";
} # fine if ($tipo_periodi == "g")
echo ")</small></div></form>";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cancella_anno\" value=\"".mex("elimina",$pag)."\">
</div></form>";
...
<div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_numero\" value=\"SI\"$numero_check> ".mex("numero",$pag)."</label></div>
<div class=\"checkbox\"><input type=\"checkbox\" name=\"colonna_cognome\" value=\"SI\"$cognome_check> ".mex("cognome cliente",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_ospite\" value=\"SI\"$ospite_check> ".mex("cognome ospite se differente",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_inizio\" value=\"SI\"$inizio_check> ".mex("data iniziale",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_fine\" value=\"SI\"$fine_check> ".mex("data finale",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_orarioentrata\" value=\"SI\"$orarioentrata_check> ".mex("orario entrata stimato",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_settimane\" value=\"SI\"$settimane_check> ".mex("n° di $parola_settimane",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_tariffacompleta\" value=\"SI\"$tariffacompleta_check> ".mex("tariffa completa",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_caparra\" value=\"SI\"$caparra_check> ".mex("caparra",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_commissioni\" value=\"SI\"$commissioni_check> ".mex("commissioni",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_restocomm\" value=\"SI\"$restocomm_check> ".mex("resto commissioni",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_pagato\" value=\"SI\"$pagato_check> ".mex("pagato",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_dapagare\" value=\"SI\"$dapagare_check> ".mex("resto da pagare",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_nometariffa\" value=\"SI\"$nometariffa_check> ".mex("nome della tariffa",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_appartamento\" value=\"SI\"$appartamento_check> ".mex("n° di appartamento",'unit.php')."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_piano\" value=\"SI\"$piano_check> ".mex("piano",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_casa\" value=\"SI\"$casa_check> ".mex("casa",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_persone\" value=\"SI\"$persone_check> ".mex("n° di persone",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_commento\" value=\"SI\"$commento_check> ".mex("commento",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_origine_prenota\" value=\"SI\"$origine_prenota_check> ".mex("origine",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_docsalvati\" value=\"SI\"$docsalvati_check> ".mex("documenti salvati",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_datainserimento\" value=\"SI\"$datainserimento_check> ".mex("data di inserimento",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_utenteinserimento\" value=\"SI\"$utenteinserimento_check> ".mex("utente",$pag)."</label></div>";
...
echo "; <label><div class=\"checkbox\"><input type=\"checkbox\" name=\"$tipo_ca$num_ca\" value=\"$nome_ca\" checked></div> ";
...
echo " \"<b>$nome_ca</b>\"</label> (".mex("abbreviazione",$pag).":
 <input class=\"form-control input-sm\" type=\"text\" name=\"soprannome_ca$num_ca\" value=\"$soprannome_ca\" size=\"6\">)";
...
echo "; <label><div class=\"checkbox\"><input type=\"checkbox\" name=\"$tipo_ca$num_ca\" value=\"$nome_ca\"></div> ";
if ($tipo_ca == "cu") echo mex("costo aggiuntivo unico",$pag);
if ($tipo_ca == "cs") echo mex("costo aggiuntivo $parola_settimanale",$pag);
echo " \"<b>$nome_ca</b>\"</label> (".mex("abbreviazione",$pag).":
 
<input type=\"text\" class=\"form-control input-sm\" name=\"soprannome_ca$num_ca\" size=\"6\">)";
$num_ca++;
...
if ($colonna_selezionata[0] == "gr") {
$nome_col_gruppo = $colonna_selezionata[1];
echo "; <label><div class=\"checkbox\"><input type=\"checkbox\" name=\"gr$num_gr\" value=\"SI\" checked></div>
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_col_tutte_prenota\" value=\"".ucfirst(mex("cambia le colonne",$pag))."\"><br>
...
".mex("Aggiungi una colonna gruppo",$pag)."
 ".mex("chiamata",$pag)." 
 <input class=\"form-control input-sm\" type=\"text\" name=\"soprannome_col_gruppo\" size=\"12\"> ".mex("con",$pag)."
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_settimane\" value=\"SI\"> ".mex("n° di $parola_settimane",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_caparra\" value=\"SI\"> ".mex("caparra",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_commissioni\" value=\"SI\"> ".mex("commissioni",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_restocomm\" value=\"SI\"> ".mex("resto commissioni",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_pagato\" value=\"SI\"> ".mex("pagato",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_dapagare\" value=\"SI\"> ".mex("resto da pagare",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_nometariffa\" value=\"SI\"> ".mex("nome della tariffa",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_appartamento\" value=\"SI\"> ".mex("n° di appartamento",'unit.php')."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_piano\" value=\"SI\"> ".mex("piano",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_casa\" value=\"SI\"> ".mex("casa",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_persone\" value=\"SI\"> ".mex("n° di persone",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_commento\" value=\"SI\"> ".mex("commento",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_origine_prenota\" value=\"SI\"> ".mex("origine",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_docsalvati\" value=\"SI\"> ".mex("documenti salvati",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_datainserimento\" value=\"SI\"> ".mex("data di inserimento",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"colonna_utenteinserimento\" value=\"SI\"> ".mex("utente",$pag)."</label></div>";
for ($numca = 0 ; $numca < $dati_ca['num'] ; $numca++) {
$nome_ca = $dati_ca[$numca]['nome'];
$tipo_ca = "c".$dati_ca[$numca]['tipo'];
echo "; <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"$tipo_ca$numca\" value=\"$nome_ca\"> ";
if ($tipo_ca == "cu") echo mex("costo aggiuntivo unico",$pag);
if ($tipo_ca == "cs") echo mex("costo aggiuntivo $parola_settimanale",$pag);
echo " \"<b>$nome_ca</b>\"</label></div>";
} # fine for $numca
echo "; ".mex("separatore",$pag).":

<div class=\"radio btradio\"><label><input type=\"radio\" name=\"separatore\" value=\"spazio\" checked> ".mex("spazio",$pag)."</label></div>
<div class=\"radio btradio\"><label><input type=\"radio\" name=\"separatore\" value=\"trattino\"> ".mex("trattino",$pag)."</label></div>
<div class=\"radio btradio\"><label><input type=\"radio\" name=\"separatore\" value=\"acapo\"> ".mex("a capo",$pag)."</label></div><br>

 
 <input type=\"hidden\" name=\"num_ca\" value=\"$num_ca\">
<table><tr><td style=\"height: 2px;\"></td></tr></table>
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_col_gruppo\" value=\"".mex("Aggiungi colonna gruppo",$pag)."\">
</div></form><table><tr><td style=\"height: 14px;\"></td></tr></table>";
...
$col_nec_vedi .= ";<div class=\"checkbox\" ><label><input type=\"checkbox\" name=\"$tipo_ca$num_ca\" value=\"$nome_ca\"$checked></div>";
...
$col_nec_vedi .= "; <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"gr$num_gr\" value=\"$nome_col_gruppo\"$checked>
 ".mex("colonna gruppo",$pag)." \"<b>$nome_col_gruppo</b>\"</label></div>";
$num_gr++;
} # fine if ($colonna_selezionata[0] == "gr")
} # fine for $num1
if ($col_nec_vedi) {
...
<input type=\"hidden\" name=\"num_gr\" value=\"$num_gr\">
<table><tr><td style=\"height: 2px;\"></td></tr></table>
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_col_nec_prenota\" value=\"".ucfirst(mex("cambia le colonne necessarie",$pag))."\"><br>
</div></form><table><tr><td style=\"height: 14px;\"></td></tr></table>";
...
echo "
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"riga_totale\" value=\"SI\"$totale_check> ".mex("totale",$pag)."</label></div>;
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"riga_tasse\" value=\"SI\"$tasse_check> ".mex("tasse",$pag)."</label></div>;
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"riga_cassa\" value=\"SI\"$cassa_check> ".mex("trasferito in cassa",$pag)."</label></div>;
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"riga_prenotacanc\" value=\"SI\"$prenotacanc_check> ".mex("soldi prenotazioni cancellate",$pag)."</label></div>.<br>
<table><tr><td style=\"height: 2px;\"></td></tr></table>

<input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("cambia le righe",$pag))."\"><br>
...
echo mex("Cambia il numero delle righe",$pag)."
 ".mex("a",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"n_num_righe_tab_tutte_prenota\" size=\"5\" value=\"$num_righe_tab_tutte_prenota\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_righe_tutte_prenota\" value=\"".mex("Cambia",$pag)."\">
...
<span class=\"field\"><select name=\"n_selezione_tab_tutte_prenota\" class=\"uniformselect\">
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_selezione_tutte_prenota\" value=\"".mex("Cambia",$pag)."\">
</div></form><hr style=\"width: 95%\">
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"nuova_aggiunta_tronca\">";
...
".mex("caratteri per colonna",$pag)."
 <input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_aggiunta_tronca\" value=\"".mex("cambia",$pag)."\">
</div></form><table><tr><td style=\"height: 6px;\"></td></tr></table>
...
echo mex("Numero di tabelle del 2° tipo",$pag).":
 <input type=\"text\" class=\"form-control input-sm\" name=\"num_tab2_prenota\" value=\"$num_tab2_prenota\" size=\"2\" maxlength=\"2\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_num_tab2_prenota\" value=\"".mex("cambia",$pag)."\">
</div></form><table><tr><td style=\"height: 6px;\"></td></tr></table>
...
echo mex("Numero di righe dopo cui ripetere la riga delle date",$pag).":
 <input type=\"text\" class=\"form-control input-sm\" name=\"linee_ripeti_date\" value=\"$linee_ripeti_date_tab_mesi\" size=\"3\" maxlength=\"3\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_linee_ripeti_date\" value=\"".mex("cambia",$pag)."\">
</div></form>
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"mostra_giorni_tab_mesi\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select>
</span>
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_mostra_giorni_tab_mesi\" value=\"".mex("cambia",$pag)."\">
</div></form>
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"allinea_tab_mesi\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span>
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_allinea_tab_mesi\" value=\"".mex("cambia",$pag)."\">
</div></form><table><tr><td style=\"height: 6px;\"></td></tr></table>
...
echo "<input type=\"text\" class=\"form-control input-sm\" name=\"colore_sel_$num1\" id=\"coltxt$num1\" size=\"8\" value=\"$colore_corr\" onchange=\"agg_colore_sel_txt($num1)\">
</span class=\"field\"><select id=\"colsel$num1\" class=\"uniformselect\" onchange=\"agg_colore_sel($num1)\" style=\"width: 60px; background-color: $colore_corr\"><option value=\"$colore_corr\" style=\"background-color: $colore_corr\">&nbsp;</option>".$options_colori."</select></span>";
} # fine for $num1
echo "</td><td>
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_colori_tab_mesi\" value=\"".mex("cambia",$pag)."\">
</td></tr></table>
</div></form><hr style=\"width: 95%\">";
...
$num_righe_tab_tutti_clienti = risul_query($num_righe_tab_tutti_clienti,0,'valpersonalizza_num');
echo mex("Cambia il numero delle righe",$pag)."
 ".mex("a",$pag)." <input class=\"form-control input-sm\" type=\"text\" name=\"n_num_righe_tab_tutti_clienti\" size=\"5\" value=\"$num_righe_tab_tutti_clienti\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_righe_tutti_clienti\" value=\"".mex("Cambia",$pag)."\">
...
<div class=\"checkbox\"><label><input type=\"checkbox\" name=\"nome_ccc\" value=\"SI\"$nome_check> ".mex("nome",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"telefono_ccc\" value=\"SI\"$telefono_check> ".mex("telefono",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"citta_ccc\" value=\"SI\"$citta_check> ".mex("città",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"indirizzo_ccc\" value=\"SI\"$indirizzo_check> ".mex("indirizzo",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"codpostale_ccc\" value=\"SI\"$codpostale_check> ".mex("codice postale",$pag)."</label></div>
 <div class=\"checkbox\"><label><input type=\"checkbox\" name=\"piva_ccc\" value=\"SI\"$piva_check> ".strtolower(mex("Partita iva",$pag))."</label></div>

 <input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_campi_cerca_clienti\" value=\"".mex("Cambia",$pag)."\">
</div></form><hr style=\"width: 95%\">";
...
<input type=\"text\" class=\"form-control input-sm\" name=\"server_email_tm\" size=\"25\" value=\"$server_email_tm\">
<small>(".mex("per es.",$pag)." \"imap.gmail.com\")</small></td></tr>
<tr><td style=\"text-align: right;\">".mex("Protocollo",$pag).":</td><td>

<span class=\"field\">
<select name=\"proto_email_tm\" class=\"uniformselect\"><option value=\"pop3\"$sel_pop3>pop3</option>
<option value=\"imap\"$sel_imap>imap</option>
<option value=\"pop3/ssl\"$sel_pop3_ssl>pop3 (ssl)</option>
<option value=\"imap/ssl\"$sel_imap_ssl>imap (ssl)</option></select></span>

</td></tr>
<tr><td style=\"text-align: right;\">".mex("Porta",$pag).":</td><td>

<div class=\"radio btradio\"><label><input type=\"radio\" name=\"tipo_porta_email_tm\" value=\"def\"$check_tp_etm_def>".mex("default",$pag)."</label></div><br>
<div class=\"radio btradio\"><label><input id=\"tp_etm_p\" type=\"radio\" name=\"tipo_porta_email_tm\" value=\"pers\"$check_tp_etm_pers>".mex("persoalizzata",$pag).":</label></div>

<input type=\"text\" class=\"form-control input-sm\" name=\"porta_email_tm\" size=\"6\" value=\"$porta_email_tm\" onfocus=\"document.getElementById('tp_etm_p').checked='1'\"></td></tr>
<tr><td style=\"text-align: right;\">".mex("Nome utente",$pag).":</td><td>
<input type=\"text\" class=\"form-control input-sm\" name=\"username_email_tm\" size=\"25\" value=\"$username_email_tm\"></td></tr>
<tr><td style=\"text-align: right;\">".mex("Password",$pag).":</td><td>
<input type=\"text\" class=\"form-control input-sm\" name=\"password_email_tm\" size=\"25\" value=\"$password_email_tm\">
...
echo "<span class=\"field\"><select class=\"uniformselect\" name=\"therad_email_tm$num1\"><option value=\"ini\"$sel_ini>".mex("Messaggio iniziale",$pag)."</option>
<option value=\"tutti\"$sel_tutti>".mex("Qualsiasi messaggio",$pag)."</option></select></span>
".mex("da",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"mittente_email_tm$num1\" value=\"".${"mittente_email_tm$num1"}."\" size=\"20\">
".mex("con oggetto contenete",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"oggetto_email_tm$num1\" value=\"".${"oggetto_email_tm$num1"}."\" size=\"18\"><br>";
} # fine for $num1
echo "<input type=\"hidden\" name=\"num_trova_email_tm\" value=\"$num_trova_email_tm\"></td><td valign=\"bottom\">";
if ($num_trova_email_tm > 1) echo "<input class=\"btn btn-primary\" class=\"form-control input-sm\" type=\"submit\" name=\"eliminatrova_email_tm\" value=\"".mex("-",$pag)."\">&nbsp;";
echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungitrova_email_tm\" value=\"".mex("+",$pag)."\"></td></tr>
<tr><td></td><td><input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Cambia",$pag)."\">
...
$num_righe_tab_messaggi = risul_query($num_righe_tab_messaggi,0,'valpersonalizza_num');
echo mex("Cambia il numero delle righe",$pag)."
 ".mex("a",$pag)." <input type=\"text\" name=\"n_num_righe_tab_messaggi\" class=\"form-control input-sm\" size=\"5\" value=\"$num_righe_tab_messaggi\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_righe_messaggi\" value=\"".mex("Cambia",$pag)."\">
</div></form><hr style=\"width: 95%\">";
...
$num_righe_tab_casse = risul_query($num_righe_tab_casse,0,'valpersonalizza_num');
echo mex("Cambia il numero delle righe",$pag)."
 ".mex("a",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"n_num_righe_tab_casse\" size=\"5\" value=\"$num_righe_tab_casse\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_righe_casse\" value=\"".mex("Cambia",$pag)."\">
</div></form><hr style=\"width: 95%\">";
...
$num_righe_tab_doc_salvati = risul_query($num_righe_tab_doc_salvati,0,'valpersonalizza_num');
echo mex("Cambia il numero delle righe",$pag)."
 ".mex("a",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"n_num_righe_tab_doc_salvati\" size=\"5\" value=\"$num_righe_tab_doc_salvati\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_righe_doc_salvati\" value=\"".mex("Cambia",$pag)."\">
</div></form><hr style=\"width: 95%\">";
...
$num_righe_tab_storia_soldi = risul_query($num_righe_tab_storia_soldi,0,'valpersonalizza_num');
echo mex("Cambia il numero delle righe",$pag)."
 ".mex("a",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"n_num_righe_tab_storia_soldi\" size=\"5\" value=\"$num_righe_tab_storia_soldi\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_righe_storia_soldi\" value=\"".mex("Cambia",$pag)."\">
</div></form><hr style=\"width: 95%\">";
...
echo mex("Cambia il numero dei documenti",$pag)."
 ".mex("a",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"nuovo_num_contratti\" size=\"5\" value=\"$max_contr\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_num_contratti\" value=\"".mex("Cambia",$pag)."\">
...
<input type=\"hidden\" name=\"aggiorna_qualcosa\" value=\"SI\">
<input type=\"hidden\" name=\"cambia_ord_contratti\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Cambia l'ordine dei documenti",$pag)."\">
</div></form>";
} # fine if ($max_contr > 1)
echo "</td></tr></table>";
if ($max_contr > 1) {
...
<input type=\"hidden\" name=\"aggiorna_qualcosa\" value=\"SI\">
<input type=\"hidden\" name=\"elimina_contratto\" value=\"SI\">
".mex("Elimina il documento",$pag)."<span class=\"field\"> <select class=\"uniformselect\" name=\"num_contr_elimina\">";
for ($num_contratto = 1 ; $num_contratto <= $max_contr ; $num_contratto++) {
if ($attiva_contratti_consentiti == "n" or $contratti_consentiti_vett[$num_contratto] == "SI") {
...
echo "</select></span><input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("elimina",$pag))."\">
</div></form>";
} # fine if ($max_contr > 1)
echo "<br>";
...
echo "</small>:
 <input type=\"text\" class=\"form-control input-sm\" name=\"nome_contratto$num_contratto\" value=\"".$nome_contratto[$num_contratto]."\" size=\"12\" maxlength=\"26\"></td>";
if ($num_colonna == 5) {
echo "</tr>";
$num_colonna = 1;
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_nomi_contratti\" value=\"".mex("cambia i nomi dei documenti",$pag)."\">
</div></div></form><br>";
...
".mex("Importa i nomi dei documenti",$pag)."
 ".mex("dell'utente",$pag)."
 <span class=\"field\">
 <select name=\"utente_importa_contratti\" class=\"uniformselect\">
$option_select_utenti_importa_contratti
</select></span>
<input class=\"btn btn-primary\" type=\"submit\" name=\"importa_nomi_contratti\" value=\"".mex("Importa",$pag)."\">
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("variabili personalizzate",$pag)."\">.
</div></form><table><tr><td style=\"height: 3px;\"></td></tr></table>";
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Backup dei documenti","crea_backup.php")."\">
</div></form><table><tr><td style=\"height: 3px;\"></td></tr></table>";
} # fine if ($id_utente == 1 and $installazione_subordinata != "SI")
echo "<hr style=\"width: 95%\">";
...
<div class=\"radio btradio\"><label><input type=\"radio\" name=\"mostra_quadro_disp\" value=\"no\"$check_mqd_no> ".mex("non mostrare",$pag)."</label></div><br>
 <div class=\"radio btradio\"><label><input type=\"radio\" name=\"mostra_quadro_disp\" value=\"app\"$check_mqd_app> ".mex("non raggruppare gli appartamenti",'unit.php')."</label></div><br>
 <div class=\"radio btradio\"><label><input type=\"radio\" name=\"mostra_quadro_disp\" value=\"reg2\"$check_mqd_reg2> ".mex("raggruppa gli appartamenti con la regola di assegnazione 2",'unit.php')."</label></div><br>
 <div class=\"radio btradio\"><label><input type=\"radio\" name=\"mostra_quadro_disp\" value=\"pers\"$check_mqd_pers> ".mex("raggruppa gli appartamenti per numero di persone",'unit.php')."</label></div>
</td><td style=\"width: 5px;\"></td><td valign=\"middle\"><input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_mostra_quadro_disp\" value=\"".mex("Cambia",$pag)."\">
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"indietro\" value=\"".mex("Torna al menù principale",$pag)."\">
</div></form><br></div>";
