...
".mex("Si è sicuri di voler <div style=\"display: inline; color: red;\"><b>azzerare</b></div>
tutte le entrate e le uscite delle prenotazioni e i soldi trasferiti in cassa del",$pag)." $anno?<br>
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cerca_prenota\" value=\"" .mex("Vedi le modifiche",$pag). "\">
 ".mex("dal",$pag)."<span class=\"field\">
<select class=\"uniformselect\" name=\"cerca_inizioperiodo\">
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"cerca_anno_inizioperiodo\">
<option value=\"$anno_prec\">$anno_prec</option>
<option value=\"$anno\" selected>$anno</option>
<option value=\"$anno_succ\">$anno_succ</option>
</select></span>

 ".mex("al",$pag)."<span class=\"field\"> 
<select class=\"uniformselect\" name=\"cerca_fineperiodo\">
<option value=\"\" selected>----</option>";
$numgiorno = 1;
do {
$data_select = date("-m-d" , mktime(0,0,0,1,$numgiorno,$anno));
...
echo "</select></span>
<span class=\"field\">
<select class=\"uniformselect\" name=\"cerca_anno_fineperiodo\">
<option value=\"$anno_prec\">$anno_prec</option>
<option value=\"$anno\" selected>$anno</option>
<option value=\"$anno_succ\">$anno_succ</option>
</select>
...
<input type=\"hidden\" name=\"senza_colori\" value=\"$senza_colori\">
<input type=\"hidden\" name=\"azzera_soldi\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Azzera entrate e uscite prenotazioni",$pag)."\">
</div></form></td>";
} # fine if ($id_utente == 1)
echo "<td align=\"right\">
<form accept-charset=\"utf-8\" method=\"post\" action=\"storia_soldi.php\"><div>
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_colori\" value=\"".mex("Senza colori",$pag)."\">";
} # fine if (!$senza_colori)
else echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"cambia_colori\" value=\"".mex("Con colori",$pag)."\">";
echo "</div></form>";
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"pagina_prenota\" value=\"$pagina_prenota\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Vedi solo le entrate-uscite",$pag)."\">
 ".mex("con metodo",$pag)."<span class=\"field\"><select class=\"uniformselect\" name=\"metodo_selezionato\">
<option value=\"\">----</option>";
...
echo "</select></span></div></form></td><td></td><td>";
...
echo "<h4 class=\"widgettitle\">".mex("Storia delle entate e uscite delle prenotazioni inserite nel",$pag)." $anno$frase_periodo</h4>";
...
<thead><tr><th colspan=4>".mex("Dati della prenotazione",$pag)."</th>
<th rowspan=2>".mex("Pagato prima",$pag)."</th>
<th rowspan=2>".mex("Pagato dopo",$pag)."</th>
<th rowspan=2>".mex("Saldo",$pag)."</th>
<th rowspan=2>".mex("Id",$pag)."</th>
<th rowspan=2>".mex("Metodo",$pag)."</th>";
if ($num_tutti_utenti > 1) echo "<th rowspan=2>".mex("Utente",$pag)."</th>";
echo "<th rowspan=2>".mex("Data_della modifica",$pag)."</th></tr></thead>

<tbody><tr><td>".mex("N°",$pag)."</td>
<td>".str_replace("_","&nbsp;",mex("Cognome_cliente",$pag))."</td>
<td>".str_replace("_","&nbsp;",mex("Data_iniziale",$pag))."</td>
<td>".str_replace("_","&nbsp;",mex("Data_finale",$pag))."</td></tr></tbody>";
