...
<input class=\"btn btn-primary\" type=\"submit\" name=\"indietro\" value=\"".mex("OK",$pag)."\">
</div></form>";
...
<input type=\"text\"  class=\" form-control input-sm\" class=\"form-control input-sm\" name=\"intervalloperiodo$num1\" value=\"".${"intervalloperiodo".$num1}."\" size=\"2\" maxlength=\"2\"><br>";
} # fine for $num1
...
<span class=\"field\"><select class=\"uniformselect\" name=\"estendi_ultima_data\">
...
<input type=\"text\"  class=\" form-control input-sm\" class=\"form-control input-sm\" name=\"sett_no_prenota\" size=\"3\" value=\"$val\">
...
<label><input type=\"radio\" name=\"m_stile_soldi\" value=\"europa\"$check_soldi_eu>1.050.000,32</label></div><br>
<div class=\"radio btradio\">
<label><input type=\"radio\" name=\"m_stile_soldi\" value=\"usa\"$check_soldi_usa>1,050,000.32</label></div>
...
<td align=\"left\">
<div class=\"radio btradio\">
<label><input type=\"radio\" name=\"m_stile_data\" value=\"europa\"$check_data_eu>27-08-2002</label></div><br>
<div class=\"radio btradio\">
<label><input type=\"radio\" name=\"m_stile_data\" value=\"usa\"$check_data_usa>08-27-2002</label></div>
...
".mex("Nome della valuta al singolare",$pag).": <input type=\"text\"  class=\" form-control input-sm\" class=\"form-control input-sm\" name=\"m_valuta_sing\" size=\"8\" value=\"$val_s\">
</td><td style=\"width: 50px;\"></td><td colspan=2>
".mex("Nome della valuta al plurale",$pag).": <input type=\"text\"  class=\" form-control input-sm\" class=\"form-control input-sm\" name=\"m_valuta_plur\" size=\"8\" value=\"$val_p\"></td>
</tr><tr><td style=\"height: 2px;\" colspan=5></td></tr><tr><td colspan=5>
".mex("Anteporre il nome della valuta?",$pag)."
<span class=\"field\">
<select name=\"anteponi_nome_valuta\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span></td></tr><tr><td style=\"height: 2px;\" colspan=5></td></tr>";
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"utente_lis\">
".str_replace("\"$utente_lis\">","\"$utente_lis\" selected>",$option_utenti)."
</select></span></td></tr></table><br>";
...
<label><input type=\"checkbox\" name=\"$tariffa\" value=\"SI\"$checked> <b>$numtariffa</b>. $nometariffa_vedi</label></div>
 (".mex("col nome",$pag)."<input class=\"form-control input-sm\" type=\"text\" name=\"$nome_tariffa_imposto\" value=\"$val\" size=\"22\">)</td>";
...
<span class=\"field\"><select class=\"uniformselect\" name=\"chiedi_num_app_tipologia\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br><table><tr><td style=\"width: 25px;\"></td><td>
".mex("Numero massimo di appartamenti",'unit.php').":
 
 <input type=\"text\"  class=\" form-control input-sm\" class=\"form-contorl input-sm\" name=\"max_num_app_tipologia\" size=\"3\" value=\"$val\">
(".mex("0 per scelta libera",$pag).").<br>
".mex("Parola da utilizzare per indicare gli appartamenti",'unit.php').":
 
 <input type=\"text\"  class=\" form-control input-sm\" class=\"form-contorl input-sm\" name=\"parola_appartamenti\" size=\"15\" value=\"$parola_appartamenti\">;
 ".mex("singolare",$pag).": <input type=\"text\"  class=\" form-control input-sm\" name=\"parola_appartamento\" size=\"15\" value=\"$parola_appartamento\">
</td></tr></table><br>";
...
<span class=\"field\"><select class=\"uniformselect\" name=\"aggiungi_tipologie\" >
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br><table><tr><td style=\"width: 25px;\"></td><td>
".mex("Numero massimo di tipologie",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" class=\"form-control input-sm\" name=\"max_num_tipologie\" size=\"3\" value=\"$val\">
</td></tr></table><br>";
...
echo "".mex("Chiedere il numero di persone?",$pag)."
 ...
 <div class=\"radio btradio\"><label><input type=\"radio\" name=\"chiedi_num_persone\" value=\"NO\"$check_NO>".mex("No",$pag)."</label></div>
 <div class=\"radio btradio\"><label><input type=\"radio\" name=\"chiedi_num_persone\" value=\"SI\"$check_SI>".mex("Si",$pag)."</label></div><br>

 
 <table><tr><td style=\"width: 25px;\"></td><td>
".mex("Numero massimo di persone",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" class=\"form-control input-sm\" name=\"max_num_persone\" size=\"3\" value=\"$val\">
...
<span class=\"field\"><select class=\"uniformselect\" name=\"costo_aggiungi_letti\" >
<option value=\"\"$sel>----</option>
$select_costi_letto
</select></span><br>

<table><tr><td style=\"width: 25px;\"></td><td>".mex("Se il costo può essere moltiplicato aggiungere al massimo",$pag)."
 <input type=\"text\"  class=\" form-control input-sm\" class=\"form-control input-sm\" name=\"max_num_aggiungi_letti\" size=\"3\" value=\"$val\">
...
".mex("Chiedere se aggiungere i costi presenti nella pagina di inserzione prenotazioni?",$pag)."
 <span class=\"field\"><select class=\"uniformselect\" name=\"mostra_costi_aggiuntivi\" >
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br><table><tr><td style=\"width: 25px;\"></td><td>
".mex("Numero di colonne dei costi aggiuntivi",$pag).":
 <input type=\"text\" class=\"form-control input-sm\" name=\"num_colonne_costi_agg\" size=\"3\" value=\"$val\">
</td></tr></table>";
...
<span class=\"field\"><select name=\"aggiungi_costi_fissi\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br><br>
...
<div class=\"checkbox\">
<input type=\"checkbox\" name=\"attiva_costo".$dati_ca[$numca]['id']."\" value=\"SI\"$checked>".mex("$tipo_costo",$pag)." <em>".$dati_ca[$numca]['nome']."</em></label></div>:
<input type=\"text\" class=\"form-control input-sm\" name=\"$nome_costo_imposto\" value=\"$val\" size=\"22\"></td>";
...
echo "<td>".mex("Categoria",$pag)." <em>$categoria</em>:
 <input type=\"text\" class=\"form-control input-sm\" name=\"nome_cat_imp$id_costo_cat\" value=\"$val\" size=\"22\"></td>";
if ($celle == $num_colonne) {
echo "</tr>";
$celle = 0;
} # fine if ($celle == $num_colonne)
...
echo "<td><div class=\"checkbox\"><label><input type=\"checkbox\" name=\"$var_motivazione\" value=\"$motivazione\"$checked> $motivazione_vedi</label></div></td>";
if ($celle == $num_colonne) {
echo "</tr>";
$celle = 0;
} # fine if ($celle == 3)
...
<div class=\"radio btradio\">
<label><input type=\"radio\" name=\"mostra_frase_alternativa_regola1\" value=\"NO\"$check_NO> ".mex("comportati come se non vi fosse più disponibilità",$pag)."</label></div><br>
<div class=\"radio btradio\"><label><input type=\"radio\" name=\"mostra_frase_alternativa_regola1\" value=\"SI\"$check_SI> ".mex("dai ancora disponibilità con questa frase alternativa",$pag)."</label></div>:

<input type=\"text\" class=\"form-control input-sm\" name=\"frase_alternativa_regola1\" size=\"65\" value=\"$val\">
</td></tr></table><br>";
...
<span class=\"field\">
<select name=\"mostra_caparra\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br>";
...
<span class=\"field\">
<select name=\"mostra_giorni_pieni\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br><br>";
...
<span class=\"field\">
<select name=\"mostra_richiesta_via_mail\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br><table><tr><td style=\"width: 25px;\"></td><td>
...
<span class=\"field\">
<select name=\"utente_mess\" class=\"uniformselect\">";
...
<span class=\"field\">
<select name=\"orig_prenota\" span=\"uniformselect\">
<option value=\"\">----</option>";
...
echo "".mex("Indirizzo email a cui inviare le richieste di prenotazione",$pag).":
 <input type=\"text\"$readonly class=\"form-control input-sm\" name=\"ind_email\" value=\"$ind_email\" size=\"25\"><br>";
...
<span class=\"field\">
<select name=\"manda_copia_richiesta_email\" class=\"uniformselect\">";
...
<span class=\"field\">
<select name=\"maschera_envelope\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span> (".mex("provare a cambiare se non si riescono a spedire le email",$pag).")<br>";
...
echo "<tr><td style=\"width: 25px;\"></td><td>".mex("Cognome",$pag)."<span class=\"field\"> <select class==\"uniformselect\" name=\"chiedi_cognome\">
...
echo "<td style=\"width: 15px;\"></td><td>".mex("Nome",$pag)." <span class=\"field\"><select class=\"uniformselect\" name=\"chiedi_nome\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td></tr>";
...
echo "<tr><td></td><td>".mex("Email",$pag)."<span class=\"field\"> <select class=\"uniformselect\"name=\"chiedi_email\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td>";
...
echo "<td></td><td>".mex("Genere",$pag).

"<span class=\"field\"> <select class=\"uniformselect\" name=\"chiedi_sesso\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td></tr>";
...
echo "<tr><td></td><td>".mex("Data di nascita",$pag)." 

<span class=\"field\">
<select name=\"chiedi_datanascita\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td>";
...
echo "<td></td><td>".mex("Documento",$pag)." 

<span class=\"field\">
<select name=\"chiedi_documento\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td></tr>";
...
echo "<tr><td></td><td>".mex("Nazione",$pag)." 

<span class=\"field\">
<select name=\"chiedi_nazione\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td>";
...
echo "<td></td><td>".mex("Regione",$pag)."
<span class=\"field\">
<select name=\"chiedi_regione\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td></tr>";
...
echo "<tr><td></td><td>".mex("Città",$pag)." 
<span class=\"field\">
<select name=\"chiedi_citta\" class=\"uniformselect\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td>";
...
echo "<td></td><td>".mex("Via",$pag)."
<select name=\"chiedi_via\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td></tr>";
...
echo "<td></td><td>".mex("Secondo telefono",$pag)." <span class=\"field\"><select class=\"uniformselect\" name=\"chiedi_telefono2\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td></tr>";
...
echo "<tr><td></td><td>".mex("Terzo telefono",$pag)." <span class=\"field\"><select class=\"uniformselect\" name=\"chiedi_telefono3\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td>";
...
echo "<td></td><td>".mex("Fax",$pag)." <span class=\"field\"><select class=\"uniformselect\" name=\"chiedi_fax\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td></tr>";
...
echo "<tr><td></td><td>".mex("Commento",$pag)." <span class=\"field\"><select class=\"uniformselect\" name=\"chiedi_commento\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td>";
...
echo "<td></td><td><small>".mex("Orario stimato di arrivo",$pag)."</small> <span class=\"field\"><select class=\"uniformselect\" name=\"chiedi_oracheckin\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></td></tr>";
...
echo "<tr><td></td><td><small>".mex("Metodo di pagamento della caparra",$pag)."</small> <span class=\"field\"><select class=\"uniformselect\" name=\"chiedi_metodopagamento\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
</select></span></td><td></td><td></td></tr>";
...
echo "<td><label><input type=\"checkbox\" name=\"var_met_paga_"."$num1\" value=\"$metodo\"$checked>$metodo"."</label>:
 <input type=\"text\" class=\"form-control input-sm\" name=\"nome_met_paga_imposto_"."$num1\" value=\"$val\" size=\"22\"></td>";
if ($celle == $num_colonne) {
echo "</tr>";
$celle = 0;
} # fine if ($celle == 3)
...
echo "$num1".". <input type=\"text\" class=\"form-control input-sm\" name=\"campo_pers$num1\" value=\"".${"campo_pers".$num1}."\" size=\"25\">
 <span class=\"field\"><select class=\"uniformselect\" name=\"chiedi_campo_pers$num1\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
</select></span><br>";
} # fine for $num1
echo "</td><td style=\"width: 20px;\"></td><td valign=\"bottom\">";
if ($num_campi_pers > 1) echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"eliminacampipers\" value=\"".mex("-",$pag)."\">&nbsp;";
echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungicampipers\" value=\"".mex("+",$pag)."\">
...
echo " $num1. <span class=\"field\"><select class=\"uniformselect\" name=\"num_doc_cond$num1\">
<option value=\"\"$sel>----</option>
".str_replace("\"".$$num_doc_cond."\">","\"".$$num_doc_cond."\" selected>",$lista_contr)."
</select></span> <span class=\"field\"><select class=\"uniformselect\" name=\"chiedi_num_doc_cond$num1\">
<option value=\"SI\"$sel_SI>$f_necessario</option>
<option value=\"opzionale\"$sel_opz>$f_opzionale</option>
</select></span><br>";
} # fine for $num1
echo "</td><td style=\"width: 14px;\"></td><td valign=\"bottom\">";
if ($num_campi_doc_cond > 1) echo "&nbsp;<input class=\"btn btn-primary\" type=\"submit\" name=\"eliminacampicond\" value=\"".mex("-",$pag)."\">";
echo "&nbsp;<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungicampicond\" value=\"".mex("+",$pag)."\">
...
<span class=\"field\"><select class=\"uniformselect\" name=\"mostra_bottone_paypal\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br>
&nbsp;&nbsp;&nbsp;&nbsp;".mex("Nome file della pagina di prenotazione immediata",$pag).":
<input type=\"text\"  class=\" form-control input-sm\" name=\"nome_modello_paypal\" size=\"65\" value=\"$val\"><br><br>";
...
<span class=\"field\"><select class=\"uniformselect\" name=\"mostra_quadro_disp\">
...
echo "".mex("Colore di sfondo della tabella",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"colore_sfondo_quadro_disponibilita\" value=\"$colore_sfondo_quadro_disponibilita\" size=\"10\"><br>
".mex("Colore del giorno di inizio settimana",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"colore_inizio_settimana_quadro_disponibilita\" value=\"$colore_inizio_settimana_quadro_disponibilita\" size=\"10\"><br>
".mex("Colore dei periodi liberi",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"colore_libero_quadro_disponibilita\" value=\"$colore_libero_quadro_disponibilita\" size=\"10\"><br>
".mex("Colore dei periodi occupati",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"colore_occupato_quadro_disponibilita\" value=\"$colore_occupato_quadro_disponibilita\" size=\"10\"><br>
".mex("Tag di apertura dei font della tabella",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"apertura_font_quadro_disponibilita\" value=\"$apertura_font_quadro_disponibilita\" size=\"25\"><br>
".mex("Tag di chiusura dei font della tabella",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"chiusura_font_quadro_disponibilita\" value=\"$chiusura_font_quadro_disponibilita\" size=\"25\"><br>";
...
<span class=\"field\"><select class=\"uniformselect\" name=\"mostra_numero_liberi_quadro_disponibilita\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br>";
...
<span class=\"field\"><select class=\"uniformselect\" name=\"allinea_disponibilita_con_arrivo\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span>
</td></tr></table><br>";

if (!$mostra_calendario_scelta_date or strtoupper($mostra_calendario_scelta_date) == $NO) { $sel_SI = ""; $sel_NO = " selected"; }
else { $sel_NO = ""; $sel_SI = " selected"; }
echo "".mex("Mostrare i calendari per la scelta delle date?",$pag)."
<span class=\"field\"><select class=\"uniformselect\" name=\"mostra_calendario_scelta_date\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br><table><tr><td style=\"width: 25px;\"></td><td>";
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"stile_riquadro_calendario\" size=\"75\" value=\"".htmlspecialchars($val)."\"><br>";
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"stile_tabella_calendario\" size=\"75\" value=\"".htmlspecialchars($val)."\"><br>";
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"stile_bottoni_calendario\" size=\"75\" value=\"".htmlspecialchars($val)."\"><br>";
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"stile_bottone_apertura_calendario\" size=\"75\" value=\"".htmlspecialchars($val)."\"><br>";
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"colore_data_attiva_calendario\" size=\"10\" value=\"".htmlspecialchars($val)."\"><br>";
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"colore_data_selezionata_calendario\" size=\"10\" value=\"".htmlspecialchars($val)."\"><br>";
echo "</td></tr></table><br>";
...
echo "".mex("Tag html di apertura per la formattazione delle font",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"apertura_tag_font\" size=\"25\" value=\"$apertura_tag_font\"><br>
".mex("Tag html di chiusura per la formattazione delle font",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"chiusura_tag_font\" size=\"25\" value=\"$chiusura_tag_font\"><br>";
...
echo "".mex("Tag html di apertura per la formattazione delle font rosse",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"apertura_tag_font_rosse\" size=\"25\" value=\"$apertura_tag_font_rosse\"><br>
".mex("Tag html di chiusura per la formattazione delle font rosse",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"chiusura_tag_font_rosse\" size=\"25\" value=\"$chiusura_tag_font_rosse\"><br>";
...
echo "".mex("Stile della tabella che racchiude la form di prenotazione",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"stile_tabella_prenotazione\" size=\"25\" value=\"$stile_tabella_prenotazione\"><br>";
...
echo "<br>".mex("Url del file css per la modalità frame",$pag).":
 <input type=\"text\"  class=\" form-control input-sm\" name=\"file_css_frame\" size=\"35\" value=\"$file_css_frame\"><br>";
...
<span class=\"field\"><select class=\"uniformselect\" name=\"apri_nuova_finestra_da_frame\">
<option value=\"SI\"$sel_SI>".mex("SI",$pag)."</option>
<option value=\"NO\"$sel_NO>".mex("NO",$pag)."</option>
</select></span><br><table><tr><td style=\"width: 25px;\"></td><td>";
echo "".mex("Geometria della nuova finestra",$pag).":
 ".mex("larghezza",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"larghezza_finestra_da_frame\" size=\"4\" value=\"$val_larghezza\">px,
 ".mex("altezza",$pag)." <input type=\"text\"  class=\" form-control input-sm\" name=\"altezza_finestra_da_frame\" size=\"4\" value=\"$val_altezza\">px.
</td></tr></table>";
...
echo "<br>".mex("Utilizza per l'aspetto della pagina",$pag).":
 <span class=\"field\"><select class=\"uniformselect\" name=\"tema_modello\" id=\"tema_sel\" onchange=\"agg_tema_sel()\">
...
$js_opz_tema .= "".mex("Colore del tema",$pag)." \"".$template_theme_name[$num1]."\" ".mex("per",$pag)." \"".$colori_tema[$num2]['name']."\":\\
 <input type=\"text\"  class=\" form-control input-sm\" name=\"colore_tema_$num2\" id=\"coltxt$num2\" size=\"8\" value=\"$colore_corr\" onchange=\"agg_colore_sel_txt($num2)\">\\
<span class=\"field\"><select class=\"uniformselect\" id=\"colsel$num2\" onchange=\"agg_colore_sel($num2)\" style=\"width: 80px; background-color: $colore_corr\"><option value=\"$colore_corr\" style=\"background-color: $colore_corr\">&nbsp;<\/option>'+options_colori+'<\/select><br>";
} # fine for $num2
...
$js_opz_tema .= "".mex("Valore del tema",$pag)." \"".$template_theme_name[$num1]."\" ".mex("per",$pag)." \"".$valori_tema[$num2]['name']."\":\\
 <input type=\"text\"  class=\" form-control input-sm\" name=\"valore_tema_$num2\" id=\"valtema$num2\" size=\"24\" value=\"$valore_corr\"><br>";
} # fine for $num2
$js_opz_tema .= "<\/td><\/tr><\/table>';
}";
} # fine for $num1
echo "</select></span><div id=\"opz_tema\"></div>";
...
if ($modello_esistente == "SI") {
for ($num_fr = 0 ; $num_fr < $num_frasi ; $num_fr++) echo "".mex($frase[$num_fr],$pag).": <input type=\"text\"  class=\" form-control input-sm\" name=\"".$fr_frase[$num_fr]."\" size=\"45\" value=\"".str_replace("\"","&quot;",${$fr_frase[$num_fr]})."\"><br>";
} # fine if ($modello_esistente == "SI")
else {
for ($num_fr = 0 ; $num_fr < $num_frasi ; $num_fr++) echo "".mex($frase[$num_fr],$pag).": <input type=\"text\"  class=\" form-control input-sm\" name=\"".$fr_frase[$num_fr]."\" size=\"45\" value=\"".str_replace("\"","&quot;",stripslashes(mex2($frase[$num_fr],$pag,$lingua_modello)))."\"><br>";
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Crea la pagina per la disponibilità",$pag)."\">
</div></div></form><br>
<hr style=\"width: 95%\"><br><div style=\"text-align: center;\">
<form accept-charset=\"utf-8\" method=\"post\" action=\"crea_modelli.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"indietro\" value=\"".mex("Torna indietro",$pag)."\">
</div></form><br></div>";
...
if ($modello_ext != "." and $modello_ext != ".." and @is_dir("./includes/templates/$modello_ext")) {
include("./includes/templates/$modello_ext/name.php");
if (${"form_".$template_name}) {
$mostra_form_creazione = "NO";
include("./includes/templates/$modello_ext/form.php");
break;
} # fine if (${"form_".$template_name})
} # fine if ($modello_ext != "." and $modello_ext != ".." and...
} # fine while ($file = readdir($lang_dig))
closedir($templates_dir);
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("NO",$pag)."\">
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("OK",$pag)."\">
</div></form>";
...
<h4 class=\"widgettitle\">".mex("Crea pagine per il sito web",$pag). "</h4><div class=\"widgetcontent\">" ;
...
<div class=\"radio btradio\">
<label><input type=\"radio\" name=\"fonte_dati_conn\" value=\"attuali\" checked>"
.mex("Utilizza i dati attuali per la connessione al database",$pag). "</label></div><br>";

if (C_BACKUP_E_MODELLI_CON_NUOVI_DATI != "NO") {

echo "<div class=\"radio btradio\">
<label><input type=\"radio\" name=\"fonte_dati_conn\" value=\"nuovi\">"
.mex("Utilizza altri dati per la connessione al database",$pag)."</label></div><br>

<table><tr><td style=\"width: 25px;\"></td><td>
".mex("Tipo di database",$pag).": 

<span class=\"field\"><select class=\"uniformselect\" name=\"T_PHPR_DB_TYPE\">
...
<input type=\"text\"  class=\" form-control input-sm\" name=\"T_PHPR_DB_NAME\"><br>
".mex("Nome del computer a cui collegarsi",$pag).":
<input type=\"text\"  class=\" form-control input-sm\" name=\"T_PHPR_DB_HOST\" value=\"localhost\"><br>
".mex("Numero della porta a cui collegarsi",$pag).": 
<input type=\"text\"  class=\" form-control input-sm\" name=\"T_PHPR_DB_PORT\" value=\"5432\">(".mex("Normalmete 5432 per Postgresql o 3306 per Mysql",$pag).")<br>
".mex("Nome per l'autenticazione al database",$pag).": 
<input type=\"text\"  class=\" form-control input-sm\" name=\"T_PHPR_DB_USER\"><br>
".mex("Parola segreta per l'autenticazione al database",$pag).": 
<input type=\"text\"  class=\" form-control input-sm\" name=\"T_PHPR_DB_PASS\"><br>
".mex("Caricare la libreria dinamica \"pgsql.so\" o \"mysql.so\"",$pag)."?
<span class=\"field\"><select class=\"uniformselect\" name=\"T_PHPR_LOAD_EXT\">
<option value=\"SI\">".mex("Si",$pag)."</option>
<option value=\"NO\" selected>".mex("No",$pag)."</option>
</select></span> <small>(".mex("scegliere si se non viene caricata automaticamente da php",$pag).")</small><br>
".mex("Prefisso nel nome delle tabelle",$pag).":
<input type=\"text\"  class=\" form-control input-sm\" name=\"T_PHPR_TAB_PRE\" maxlength=\"8\" size=\"9\">
</td></tr></table>";
...
echo "<br>".mex("Anno",$pag).": <span class=\"field\"><select class=\"uniformselect\" name=\"anno_modello\">";
...
".mex("Lingua",$pag).":
 <span class=\"field\"><select class=\"uniformselect\" name=\"lingua_modello\">
...
echo "".mex("Cartella",$pag).":
 <span class=\"field\"><select class=\"uniformselect\" name=\"perc_cart_mod_sel\">";
for ($num_cart = 0 ; $num_cart < $num_perc_cart_mod_vett ; $num_cart++) {
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"form_modello_disponibilita\" value=\"".mex("Pagina per la disponibilità",$pag)."\">
</div>";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"form_$template_name\" value=\"".$nome_modello_ext."\">
</div>";
} # fine if ($modello_ext != "." and $modello_ext != ".." and...
} # fine while ($file = readdir($lang_dig))
closedir($templates_dir);
...
".mex("Importa le pagine dalla cartella",$pag)."
 <span class=\"field\"><select class=\"uniformselect\" name=\"cartella_da\">
<option value=\"\" selected>----</option>";
for ($num_cart = 0 ; $num_cart < $num_perc_cart_mod_vett ; $num_cart++) {
echo "<option value=\"".$perc_cart_mod_vett[$num_cart]."\">".$perc_cart_mod_vett[$num_cart]."</option>";
} # fine for $num_cart
echo "</select></span> ".mex("alla cartella",$pag)."
 <span class=\"field\"><select class=\"uniformselect\" name=\"cartella_a\">
<option value=\"\" selected>----</option>";
for ($num_cart = 0 ; $num_cart < $num_perc_cart_mod_vett ; $num_cart++) {
echo "<option value=\"".$perc_cart_mod_vett[$num_cart]."\">".$perc_cart_mod_vett[$num_cart]."</option>";
} # fine for $num_cart
echo "</select></span>
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Importa",$pag)."\">
</div></form></div>";
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"cancella_modelli\" value=\"SI\">
".mex("Cancella",$pag)." <span class=\"field\"><select class=\"uniformselect\" name=\"perc_mod_elimina\">
...
echo "</select></span>
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Cancella",$pag)."\">
</div></form></div>";
