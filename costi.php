...
<h4 class=\"widgettitle\">".mex("Inserisci le entrate in cassa per l'anno", $pag).$anno."</h4>
...
<input type=\"text\"  class=\"form-control input-sm\" name=\"nome_costo\" size=\"30\" value=\"\">
</td></tr>
<tr><td>
".mex("Importo",$pag).":&nbsp;
<input type=\"text\"  class=\"form-control input-sm\" name=\"val_costo\" size=\"10\" value=\"\">&nbsp;$Euro.
</td></tr>
$metodo_pagamento_txt";
if ($priv_persona_ins_costi == "c") {
echo "<tr><td>".mex("Persona che inserisce",$pag).":&nbsp;
<input type=\"text\" class=\"form-control input-sm\" name=\"persona_costo\" size=\"20\" value=\"\">&nbsp;(".mex("opzionale",$pag).").
</td></tr>";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"inserisci_entrata\" value=\"".mex("Inserisci l' entrata",$pag)."\"><br>
</div></div></form>
</div></div>
...
if ($priv_ins_spese == "s") {
echo "<div class=\"widgetbox\">
<h4 class=\"widgettitle\">".mex("Inserisci i costi di gestione per l'anno",$pag).
"$anno</h4><div class=\"widgetcontent\"></h3>
<form accept-charset=\"utf-8\" method=\"post\" action=\"costi.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\"><br>
<table style=\"margin-left: auto; margin-right: auto;\" cellspacing=2 cellpadding=5>
...
echo "</table><div style=\"text-align: center;\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"inserisci_spesa\" value=\"".mex("Inserisci la spesa",$pag)."\"><br>
</div></div></form>
<table><tr><td style=\"height: 8px;\"></td></tr></table><hr style=\"width: 95%\">";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"visualizza\" value=\"".mex("Visualizza la tabella con tutte le spese e le entrate",$pag)."\">
</div></form>";
