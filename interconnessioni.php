...
<h4 class=\"widgettitle\">".mex("Interconnessioni con sorgenti esterne di dati",$pag)."</h4>
...
<span class=\"field\"> 
<select class=\"uniformselect\" name=\"n_utente_agg\">";
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"modifica_interconnessione\" value=\"SI\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cancella_subordinazione\" value=\"".mex("Cancella",$pag)."\">
...
<input type=\"text\"  class=\"form-control input-sm\"  name=\"url_subordinazione\" value=\"http://\" size=60><br>
...
<input type=\"text\" class=\"form-control input-sm\" name=\"utente_subordinazione\" size=20><br>
".mex("Password",$pag).":
<input type=\"text\"  class=\" form-control input-sm\" name=\"password_subordinazione\" size=20></td></tr></table>
".mex("Commento da aggiungere al titolo di questa installazione",$pag).":
<input type=\"text\"  class=\" form-control input-sm\" name=\"commento_subordinazione\" size=20><br>

<div class=\"checkbox\">
<label><input type=\"checkbox\" name=\"compresso_subordinazione\" value=\"SI\" checked> ".mex("Usa compressione",$pag)."</label></div><br>
<div class=\"checkbox\">
...
<div style=\"text-align: center;\"><input class=\"btn btn-primary\" type=\"submit\" name=\"crea_subordinazione\" value=\"".mex("Crea la subordinazione",$pag)."\">
</div></div></form>";
