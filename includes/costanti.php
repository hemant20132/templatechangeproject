...
define('C_MASSIMO_NUM_UTENTI',40);
define('C_MASSIMO_NUM_CLIENTI',70000);
define('C_MASSIMO_NUM_TARIFFE',70);
define('C_MASSIMO_NUM_CONTRATTI',70);
define('C_MASSIMO_NUM_COSTI_AGG',150);
define('C_MASSIMO_NUM_COSTI_AGG_IN_PRENOTA',50);
define('C_MASSIMO_NUM_STORIA_SOLDI',90000);
