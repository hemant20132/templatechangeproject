...
$tariffa_colonna_periodo[$num1][$num_colonne_periodi] += (double) risul_query($periodi,($inizioperiodi_id[$num_p] + $num_i),$tariffa[$num1]);
$tariffap_colonna_periodo[$num1][$num_colonne_periodi] += (double) risul_query($periodi,($inizioperiodi_id[$num_p] + $num_i),$tariffa[$num1]."p");
...
${$tariffa[$num2]} += (double) risul_query($periodi,($num1 + $num_i),$tariffa[$num2]);
${$tariffa[$num2]."p"} += (double) risul_query($periodi,($num1 + $num_i),$tariffa[$num2]."p");
...
if ((!$tariffa_colonna_periodo[$num1][$num2] and !$tariffap_colonna_periodo[$num1][$num2]) or $tariffa_colonna_periodo[$num1][$num2] == "c") $tariffa_vedi = "&nbsp;";
else {
