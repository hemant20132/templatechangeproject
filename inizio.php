...
HOTELDRUID version ".C_PHPR_VERSIONE_TXT.", Copyright (C) 2001-2014 Marco M. F. De Santis<br>
...
<br><br>
".mex("Scegli la lingua",$pag).":<span class=\"field\"> 
<select class=\"uniformselect\" name=\"lingua\">";
...
closedir($lang_dir);
echo "</select><br>
<input class=\"btn btn-primary\" type=\"submit\" name=\"crealo\" value=\"".mex("crea il database",$pag)."\"><br>
</div></form>";
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Aggiorna",$pag)."\">
</small></div></form>";
...
echo "<br>
      <div class=\"widgetbox\">
      <h4 class=\"widgettitle\">".mex("Menù principale dell'anno",$pag)." $anno</h4>
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"prenota\" value=\"".mex("Inserisci una nuova prenotazione",$pag)."\"><br>
...
echo "<span class=\"field\"><select name=\"mese\" class=\"uniformselect\">
...
<div class=\"radio btradio\">
                        <label>
						<input type=\"radio\" name=\"anno_succ\" value=\"NO\" checked>$anno</label>       
	                    </label>
                    </div><br>
...
<div class=\"radio btradio\">
  ...
  <input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("visualizza",$pag))."\">
...
<select class=\"uniformselect\" name=\"tipo_tabella\">";
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"clienti\" value=\"".mex("Inserisci un nuovo cliente",$pag)."\"><br>
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"ins_costi\" value=\"".mex("Spese ed entrate",$pag)."\"><br>
</div></form></td><td style=\"width: 15px;\"></td>";
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"ins_costi\" value=\"".mex("Punto vendita",$pag)."\"><br>
</div></form></td><td style=\"width: 15px;\"></td>";
...
if (numlin_query($messaggi) > 0) $nuovo_mess = 1;
} # fine if ($numconnessione)
if ($nuovo_mess) {
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
$gt<input class=\"btn btn-primary\" type=\"submit\" name=\"ins_costi\" value=\"".mex("Messaggi",$pag)."\">$lt<br>
</div></form></td><td style=\"width: 15px;\"></td>";
...
echo " (".mex("per",$pag)."
 ...
 ".mex("persone",$pag).")
<input class=\"btn btn-primary\" type=\"submit\" name=\"con_dis\" value=\"".ucfirst(mex("controlla",$pag))."\">
...
if (!$checkin) echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"ins_checkin\" value=\"".mex("Entrata",$pag)."\">";
if ($checkin and !$checkout) echo "<input id=\"cobutton\" class=\"btn btn-primary\" type=\"submit\" name=\"ins_checkout\" value=\"".mex("Uscita",$pag)."\">";
echo "</div></form></td>";
...
if (!$checkin) echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"ins_checkin\" value=\"".mex("Entrata e pagato",$pag)."\">";
if ($checkin and !$checkout) echo "<input id=\"copbutton\" class=\"btn btn-primary\" type=\"submit\" name=\"ins_checkout\" value=\"".mex("Uscita e pagato",$pag)."\">";
echo "</div></form></td>";
} # fine if ($colore and...
...
echo "<form style=\"position:relative;left:425px;\" accept-charset=\"utf-8\" method=\"post\"  action=\"creaprezzi.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input style=\"text-align:center;\" class=\"btn btn-primary\" type=\"submit\" name=\"insprezzi\" value=\"".mex("Inserisci o modifica i prezzi",$pag)."\">
...
echo "<form style=\"position:relative;left:425px;\" accept-charset=\"utf-8\" method=\"post\" action=\"crearegole.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"insregole\" value=\"".mex("Inserisci o modifica le regole di assegnazione",$pag)."\"><br>
</div></form><div style=\"height: 10px\"></div>";
} # fine if ($id_utente == 1 and $installazione_subordinata != "SI")
if ($modifica_pers != "NO" or $priv_crea_backup == "s")
{
echo "<form style=\"position:relative;left:425px;\" accept-charset=\"utf-8\" method=\"post\" action=\"personalizza.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"insregole\" value=\""
.mex("Configura e personalizza",$pag)."\"><br>
</div></form>
<div style=\"height: 10px\"></div>";
} # fine if ($modifica_pers != "NO" or $priv_crea_backup == "s")
echo "<form accept-charset=\"utf-8\" style=\"position:relative;left:425px;\" method=\"post\" action=\"inizio.php\"><div>
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
".ucfirst(mex("richiedi l'anno",$pag))."
<input type=\"text\" name=\"anno\" size=\"4\" maxlength=\"4\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"vai\" value=\"".mex("vai",$pag)."\">
</div>
</form>
<br>
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"creaanno\" value=\"".mex("Crea l'anno",$pag)." $anno \">
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"giorno_ini_fine\">
...
</select></span> ".mex("come giorno di inizio/fine locazione",$pag)."<br>";
...
<span class=\"field\">
<select class=\"uniformselect\" name=\"mese_ini\">
...
</select></span>".mex("a",$pag)."

<span class=\"field\">
<select  class=\"uniformselect\" name=\"mese_fine\">
...
<option value=\"10\">".mex("Ottobre",$pag)."</option>
<option value=\"11\">".mex("Novembre",$pag)."</option>
<option value=\"12\" selected>".mex("Dicembre",$pag)."</option>
...
<option value=\"24\">".mex("Dic",$pag).". ".mex("anno successivo",$pag)."</option>";
...
<label>
<input type=\"checkbox\" name=\"importa_anno_prec\" value=\"SI\" checked>
".mex("Importa dall'anno precedente prenotazioni, tariffe (compresi costi aggiuntivi), privilegi degli utenti e regole d'assegnazione.",$pag)."</label></div>";
...
<input class=\"form-control input-sm\" type=\"text\" name=\"anno\" size=\"4\" maxlength=\"4\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"vai\" value=\"".mex("vai",$pag)."\"><br>
</div></form></div></div>";
if ($tema[$id_utente] != "base") include("./themes/".$tema[$id_utente]."/php/foot.php");
else include("./includes/foot.php");
