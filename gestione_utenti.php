...
echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"cont\" value=\"".mex("Continua",$pag)."\">
</div></form><br>
...
echo "".mex("Nuovo gruppo",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"nuovo_gruppo\" size=\"12\"><br><br>
<input class=\"btn btn-primary\" type=\"submit\" name=\"cont\" value=\"".mex("Modifica",$pag)."\">
...
.mex("Gestione degli utenti di hoteldruid",$pag)."</h4>
...
<thead>
<tr> <th align=\"center\">".mex("N°",$pag)."</th>
<th align=\"center\">".mex("nome",$pag)."</th>
<th align=\"center\">".mex("login",$pag)."</th>
<th align=\"center\">".mex("modifica",$pag)."</th></tr></thead><tbody>";
$anni = esegui_query("select * from $tableanni order by idanni");
$num_anni = numlin_query($anni);
...
if ($id == 1) echo "*";
echo "</td>
<td align=\"center\" valign=\"middle\"><input  class=\"form-control input-sm\" type=\"text\" name=\"nome$id\" size=\"15\" value=\"$nome\"></td>
<td align=\"center\" valign=\"middle\">

<span class=\"field\">
<select name=\"tipo_pass$id\" class=\"uniformselect\">";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"modifica_utenti\" value=\"".mex("Modifica gli utenti",$pag)."\">
</div></form></div><br>";
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
".mex("Aggiungi",$pag)."
 ".mex("un nuovo utente chiamato",$pag)." <input control =\"form-control input-sm\" type=\"text\" name=\"nome\" size=\"15\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_utente\" value=\"".mex("Aggiungi",$pag)."\">
</div></form>";
