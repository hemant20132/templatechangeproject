...
if ($num_id_prenota == 1) echo "
   <div class=\"widgetbox\">
  <h4 class=\"widgettitle\">".mex("Modifica gli ospiti della prenotazione",$pag)." $id_prenota</h4>
  <div class=\"widgetcontent\">";
else echo "
   <div class=\"widgetbox\">
   <h4 class=\"widgettitle\">"
   .mex("Modifica gli ospiti delle prenotazioni",$pag)."". str_replace(",",", ",$id_prenota_int)."</h4>
     <div class=\"widgetcontent\">";
...
echo "<br>$n_o. ".mex("Cognome",$pag).": input type=\"text\" class=\"form-control input-sm\" id=\"cognome$id_prenota"."_$n_o\" name=\"cognome$id_prenota"."_$n_o\">
<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('cognome$id_prenota"."_$n_o','cognome$id_prenota"."_$n_ini','$cognome_def')\" value=\"#\">,
".mex("nome",$pag).": input type=\"text\" class=\"form-control input-sm\" name=\"nome$id_prenota"."_$n_o\">;
".mex("sesso",$pag).": <span class=\"field\"><select class=\"uniformselect\" name=\"sesso$id_prenota"."_$n_o\">
<option value=\"\" selected>-</option>
<option value=\"m\">m</option>
<option value=\"f\">f</option>
</select></span>;<br>
".mex("cittadinanza",$pag).": ".mostra_lista_relutenti("nazionalita$id_prenota"."_$n_o","",$id_utente,"nome_nazione","idnazioni","idnazione",$tablenazioni,$tablerelutenti)."<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('nazionalita$id_prenota"."_$n_o','nazionalita$id_prenota"."_$n_ini','$nazione_def')\" value=\"#\">;
...
$sel_gnascita = "<span class=\"field\"><select class=\"uniformselect\" name=\"giornonascita$id_prenota"."_$n_o\">
<option value=\"\" selected>--</option>";
for ($num = 1; $num <= 31; $num++) {
if (strlen($num) == 1) $num = "0".$num;
$sel_gnascita .= "<option value=\"$num\">$num</option>";
} # fine for $num
$sel_gnascita .= "</select></span>";
$sel_mnascita = "<span class=\"field\"><select class=\"uniformselect\" name=\"mesenascita$id_prenota"."_$n_o\">
<option value=\"\" selected>--</option>";
for ($num = 1; $num <= 12; $num++) {
if (strlen($num) == 1) $num = "0".$num;
$sel_mnascita .= "<option value=\"$num\">$num</option>";
} # fine for $num
$sel_mnascita .= "</select></span>";
if ($stile_data == "usa") echo "$sel_mnascita/$sel_gnascita";
else echo "$sel_gnascita/$sel_mnascita";
echo "/input type=\"text\" class=\"form-control input-sm\" name=\"annonascita$id_prenota"."_$n_o\" size=\"5\" maxlength=\"4\" value=\"19\"> (".mex("anno con 4 cifre",$pag)."),
 ".mex("nazione di nascita",$pag).": ".mostra_lista_relutenti("nazionenascita$id_prenota"."_$n_o","",$id_utente,"nome_nazione","idnazioni","idnazione",$tablenazioni,$tablerelutenti,"","","","regione","regionenascita$id_prenota"."_$n_o")."<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('nazionenascita$id_prenota"."_$n_o','nazionalita$id_prenota"."_$n_o','$nazione_def')\" value=\"#\">,<br>
".mex("reg./prov. di nascita",$pag).": ".mostra_lista_relutenti("regionenascita$id_prenota"."_$n_o","",$id_utente,"nome_regione","idregioni","idregione",$tableregioni,$tablerelutenti,"","","","citta","cittanascita$id_prenota"."_$n_o","nazione")."<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('regionenascita$id_prenota"."_$n_o','regionenascita$id_prenota"."_$n_ini','$regione_def')\" value=\"#\">,
 ".mex("città di nascita",$pag).": ".mostra_lista_relutenti("cittanascita$id_prenota"."_$n_o","",$id_utente,"nome_citta","idcitta","idcitta",$tablecitta,$tablerelutenti,"","","","","","regione")."<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('cittanascita$id_prenota"."_$n_o','cittanascita$id_prenota"."_$n_ini','$citta_def')\" value=\"#\"><br>
<div style=\"height: 2px\"></div>";
if ($n_o == 1) {
echo "".mex("Nazione",$pag).": ".mostra_lista_relutenti("nazione$id_prenota"."_$n_o","",$id_utente,"nome_nazione","idnazioni","idnazione",$tablenazioni,$tablerelutenti,"","","","regione","regione$id_prenota"."_$n_o")."<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('nazione$id_prenota"."_$n_o','nazionalita$id_prenota"."_$n_o','$nazione_def')\" value=\"#\">,
 ".mex("reg./prov.",$pag).": ".mostra_lista_relutenti("regione$id_prenota"."_$n_o","",$id_utente,"nome_regione","idregioni","idregione",$tableregioni,$tablerelutenti,"","","","citta","citta$id_prenota"."_$n_o","nazione")."<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('regione$id_prenota"."_$n_o','regione$id_prenota"."_$n_ini','$regione_def')\" value=\"#\">,
 ".mex("città",$pag).": ".mostra_lista_relutenti("citta$id_prenota"."_$n_o","",$id_utente,"nome_citta","idcitta","idcitta",$tablecitta,$tablerelutenti,"","","","","","regione")."<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('citta$id_prenota"."_$n_o','citta$id_prenota"."_$n_ini','$citta_def')\" value=\"#\"><br>
<div style=\"height: 2px\"></div>
...
echo "input type=\"text\" class=\"form-control input-sm\" name=\"documento$id_prenota"."_$n_o\">
 ".mex("scadenza",$pag).": ";
$sel_gscaddoc = "<span class=\"field\"><select class=\"uniformselect\" name=\"giornoscaddoc$id_prenota"."_$n_o\">
<option value=\"\" selected>--</option>";
for ( $num = 1; $num <= 31; $num = $num + 1) {
if (strlen($num) == 1) $num = "0".$num;
$sel_gscaddoc .= "<option value=\"$num\">$num</option>";
} # fine for $num
$sel_gscaddoc .= "</select></span>";
$sel_mscaddoc = "<span class=\"field\"><select class=\"uniformselect\" name=\"mesescaddoc$id_prenota"."_$n_o\">
<option value=\"\" selected>--</option>";
for ( $num = 1; $num <= 12; $num = $num + 1) {
if (strlen($num) == 1) $num = "0".$num;
$sel_mscaddoc .= "<option value=\"$num\">$num</option>";
} # fine for $num
$sel_mscaddoc .= "</select></span>";
if ($stile_data == "usa") echo "$sel_mscaddoc/$sel_gscaddoc";
else echo "$sel_gscaddoc/$sel_mscaddoc";
echo "/<span class=\"field\"><select class=\"uniformselect\" name=\"annoscaddoc$id_prenota"."_$n_o\">";
...
echo "</select></span>;<br>
".mex("nazione di rilascio",$pag).": ".mostra_lista_relutenti("nazionedoc$id_prenota"."_$n_o","",$id_utente,"nome_nazione","idnazioni","idnazione",$tablenazioni,$tablerelutenti,"","","","regione","regionedoc$id_prenota"."_$n_o")."<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('nazionedoc$id_prenota"."_$n_o','nazionalita$id_prenota"."_$n_o','$nazione_def')\" value=\"#\">,
 ".mex("reg./prov.",$pag).": ".mostra_lista_relutenti("regionedoc$id_prenota"."_$n_o","",$id_utente,"nome_regione","idregioni","idregione",$tableregioni,$tablerelutenti,"","","","citta","cittadoc$id_prenota"."_$n_o","nazione")."<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('regionedoc$id_prenota"."_$n_o','regione$id_prenota"."_$n_o','$regione_def')\" value=\"#\">,
 ".mex("città",$pag).": ".mostra_lista_relutenti("cittadoc$id_prenota"."_$n_o","",$id_utente,"nome_citta","idcitta","idcitta",$tablecitta,$tablerelutenti,"","","","","","regione")."<input type=\"button\" class=\"btn btn-default\" onclick=\"cp_val('cittadoc$id_prenota"."_$n_o','citta$id_prenota"."_$n_o','$citta_def')\" value=\"#\"><br>";
} # fine if ($n_o == 1)
} # fine for $num1
...
<input class=\"btn btn-primary\" id=\"modi\" type=\"submit\" value=\"".mex("Modifica gli ospiti",$pag)."\">
</div></div></form>";
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" name=\"tipo_tabella\" value=\"$tipo_tabella\">
<input class=\"btn btn-primary\" id=\"indi\" type=\"submit\" value=\"".mex("Torna indietro",$pag)."\">
