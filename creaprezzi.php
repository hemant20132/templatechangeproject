...
".mex("Il costo aggiuntivo",$pag)." \"$nomecostoagg\" ".mex("è stato inserito",$pag).".
 <input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Modifica il costo",$pag)."\">
</div></form><br><br>";
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"ok\" value=\"OK\"><br>
</div></form>";
...
<input type=\"text\" class=\"form-control input-sm\" name=\"nomecostoagg\" size=\"24\" value=\"$nomecostoagg\">.<br><br>";
...
</label><input type=\"text\" class=\"form-control input-sm\" name=\"valore_f_ca\" value=\"$valore_f_ca\" size=\"12\"
...
</label><input type=\"text\" class=\"form-control input-sm\" name=\"valore_p_ca_t\" value=\"$valore_p_ca_t\" size=\"4\"
 onclick=\"document.getElementById('tsb_t').checked='1'\"><label for=\"tsb_t\">% 
".mex("della tariffa",$pag)." ".mex("arrotondato a",$pag)."
</label><input type=\"text\" class=\"form-control input-sm\" name=\"arrotonda_ca_t\" value=\"$arrotonda_ca_t\" size=\"6\"
...
</label><input type=\"text\" class=\"form-control input-sm\" class=\"form-control input-sm\" name=\"valore_p_ca_p\" value=\"$valore_p_ca_p\" size=\"4\"
 onclick=\"document.getElementById('tsb_p').checked='1'\"><label for=\"tsb_p\">% 
".mex("del prezzo di una persona",$pag)." ".mex("arrotondato a",$pag)."
</label><input type=\"text\" class=\"form-control input-sm\" class=\"form-control input-sm\" name=\"arrotonda_ca_p\" value=\"$arrotonda_ca_p\" size=\"6\"
...
</label><input type=\"text\" class=\"form-control input-sm\" name=\"valore_p_ca_pt\" value=\"$valore_p_ca_pt\" size=\"4\"
 onclick=\"document.getElementById('tsb_pt').checked='1'\"><label for=\"tsb_pt\">% 
".mex("del prezzo totale",$pag)." ".mex("arrotondato a",$pag)."
</label><input type=\"text\" class=\"form-control input-sm\" name=\"arrotonda_ca_pt\" value=\"$arrotonda_ca_pt\" size=\"6\"
...
echo "".mex("Tasse",$pag).": <input type=\"text\" class=\"form-control input-sm\" name=\"tasseperc_ca\" value=\"$tasseperc_ca\" size=\"4\">%
...
<input type=\"text\" class=\"form-control input-sm\" name=\"valminmax_pm\" size=\"3\" value=\"$valminmax_pm\">.<br><br>";
} # fine if ($tipocostoagg == "perm_min")
...
".mex("Se la prenotazione ha una durata di",$pag)."
 </label><input type=\"text\" class=\"form-control input-sm\" name=\"valminmax_pm\" size=\"3\" value=\"$valminmax_pm\"
...
<input type=\"text\" class=\"form-control input-sm\" name=\"ass_gio_ini_num\" value=\"".$ass_gio_ini_num."\" size=\"3\"
...
<input type=\"text\" class=\"form-control input-sm\" name=\"ass_pren_cont_num\" value=\"".$ass_pren_cont_num."\" size=\"3\"
...
if ($num1 > 1) echo "</td><td id=\"minus_pp$num1\"><input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_periodo_permesso\" value=\"".mex("Elimina un periodo",$pag)."\" onclick=\"elim_lin_per_perm();\"></td></tr><tr><td></td><td></td><td>";
else $id_minus = " id=\"minus_pp$num1\"";
echo "</td><td$id_minus><input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_periodo_permesso\" value=\"".mex("Aggiungi un periodo",$pag)."\" onclick=\"agg_lin_per_perm();\">";
...
cella.innerHTML = '<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_periodo_permesso\" value=\"".str_replace("'","\\'",mex("Elimina un periodo",$pag))."\" onclick=\"elim_lin_per_perm();\">';
...
cella.innerHTML = '<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_periodo_permesso\" value=\"".str_replace("'","\\'",mex("Aggiungi un periodo",$pag))."\" onclick=\"agg_lin_per_perm();\">';
...
<input type=\"text\" class=\"form-control input-sm\" name=\"numlimite_ca\" value=\"$numlimite_ca\" size=\"4\" onclick=\"document.getElementById('li_s').checked='1';\">
</td></tr></table><br>";
} # fine if ($tipocostoagg == "letto_agg")
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Inserisci il costo aggiuntivo",$pag)."\">
</div></div></form>
<br><hr style=\"width: 95%\"><br>
<form accept-charset=\"utf-8\" method=\"post\" action=\"$action\"><div style=\"text-align: center;\">
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"ok\" value=\"".mex("Torna indietro",$pag)."\"><br>
</div></form><br><br><br>";
} # fine if (!$inseriscicosti)
...
<input type=\"text\" class=\"form-control input-sm\" name=\"valore_f_ca\" value=\"$valore_f_ca\" size=\"12\">$Euro <b>+</b></td></tr>
<tr><td></td><td>";
echo " ".mex("percentuale su",$pag)."

<select class=\"uniformselect\" name=\"tipo_percentuale\">";
...
<input type=\"text\" class=\"form-control input-sm\" name=\"valore_p_ca\" value=\"$valore_p_ca\" size=\"4\">% ".mex("arrotondato a",$pag)."
<input type=\"text\" class=\"form-control input-sm\" name=\"arrotonda_ca\" value=\"$arrotonda_ca\" size=\"6\">$Euro</td></tr>
</table><br>";
if (!$tasseperc_ca) $tasseperc_ca = "0";
...
<input type=\"text\" class=\"form-control input-sm\" name=\"tasseperc_ca\" value=\"$tasseperc_ca\" size=\"4\" onclick=\"document.getElementById('t_tas').checked='1';\"><label for=\"t_tas\">%
...
else elem_valminmax2.innerHTML = ' ".mex("e",$pag)." <input type=\"text\" class=\"form-control input-sm\" name=\"valminmax2'+tariffa+'\" value=\"'+valminmax2+'\" size=\"3\"> ';
}
-->
</script>
...
<input type=\"text\" class=\"form-control input-sm\" name=\"valminmax$tariffa\" value=\"".${"valminmax".$tariffa}."\" size=\"3\">
...
echo "<input type=\"radio\" id=\"ns_s\" name=\"numsett_ca\" value=\"s\"$checked>
 <input type=\"text\" class=\"form-control input-sm\" name=\"val1_prime_si\" value=\"$val1_prime_si\" size=\"3\" onfocus=\"document.getElementById('ns_s').checked='1';\">
 <label for=\"ns_s\">".mex("$parola_settimane sì",$pag)." ".mex("e",$pag)."</label>
 <input type=\"text\" class=\"form-control input-sm\" name=\"val2_prime_si\" value=\"$val2_prime_si\" size=\"3\" onfocus=\"document.getElementById('ns_s').checked='1';\">
...
echo "<input type=\"radio\" id=\"ns_n\" name=\"numsett_ca\" value=\"n\"$checked>
 <input type=\"text\" class=\"form-control input-sm\" name=\"val1_prime_no\" value=\"$val1_prime_no\" size=\"3\" onfocus=\"document.getElementById('ns_n').checked='1';\">
 <label for=\"ns_n\">".mex("$parola_settimane no",$pag)." ".mex("e",$pag)."</label>
 <input type=\"text\" class=\"form-control input-sm\" name=\"val2_prime_no\" value=\"$val2_prime_no\" size=\"3\" onfocus=\"document.getElementById('ns_n').checked='1';\">
...
<input type=\"text\" class=\"form-control input-sm\" name=\"agg_moltiplica_1\" value=\"$agg_moltiplica_1\" size=\"3\" onclick=\"document.getElementById('mo_1').checked='1';\"></td></tr>";
...
<input type=\"text\" class=\"form-control input-sm\" name=\"agg_moltiplica_p\" value=\"$agg_moltiplica_p\" size=\"3\" onclick=\"document.getElementById('mo_p').checked='1';\">
...
<input type=\"text\" class=\"form-control input-sm\" name=\"agg_moltiplica_t\" value=\"$agg_moltiplica_t\" size=\"3\" onclick=\"document.getElementById('mo_t').checked='1';\"></td></tr>";
if ($associa_tariffe == "n" and !$assegna_da_giorno_ini and !$assegna_prenota_contemp) {
...
<input type=\"radio\" id=\"mm_n\" name=\"tipo_moltmax\" value=\"n\"$checked_tipo_n>
 <input type=\"text\" class=\"form-control input-sm\" name=\"moltmax\" value=\"$moltmax\" size=\"3\" onclick=\"document.getElementById('mm_n').checked='1';\">
...
<label><input type=\"radio\" id=\"mm_p\" name=\"tipo_moltmax\" value=\"p\"$checked_tipo_p>
 ...
 <input type=\"text\" class=\"form-control input-sm\" name=\"meno_moltmax_p\" value=\"$meno_moltmax_p\" size=\"2\" onclick=\"document.getElementById('mm_p').checked='1';\"></td></tr>
<tr><td colspan=\"2\"></td><td onclick=\"document.getElementById('mo_c').checked='1';\">
<label><input type=\"radio\" id=\"mm_t\" name=\"tipo_moltmax\" value=\"t\"$checked_tipo_t>
 ...
 <input type=\"text\" class=\"form-control input-sm\" name=\"meno_moltmax_t\" value=\"$meno_moltmax_t\" size=\"2\" onclick=\"document.getElementById('mm_t').checked='1';\"></td></tr>";
} # fine if ($associa_tariffe == "n" and...
...
<\/select> x <input type=\"text\" class=\"form-control input-sm\" name=\"molt_bene_inv_sel'+numcaselle_inv+'\" value=\"1\" size=\"4\">';
cella = nlinea.insertCell(3);
cella.id = 'minus'+numcaselle_inv;
cella.innerHTML = '<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_bene_inv_elimina\" value=\"".str_replace("'","\\'",mex("Elimina un bene",$pag))."\" onclick=\"elim_lin_bene_inv();\">';
minus_prec.innerHTML = '';
...
cella.innerHTML = '<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_bene_inv_elimina\" value=\"".str_replace("'","\\'",mex("Aggiungi un bene",$pag))."\" onclick=\"agg_lin_bene_inv();\">';
...
</select> x <input type=\"text\" class=\"form-control input-sm\" name=\"molt_bene_inv_sel$num1\" value=\"".${"molt_bene_inv_sel".$num1}."\" size=\"4\">";
if ($num1 == $num_beni_inv_elimina_sel) {
$id_minus = " id=\"minus".($num1 + 1)."\"";
if ($num1 > 1) echo "</td><td id=\"minus$num1\"><input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_bene_inv_elimina\" value=\"".mex("Elimina un bene",$pag)."\" onclick=\"elim_lin_bene_inv();\"></td></tr><tr><td></td><td></td><td>";
else $id_minus = " id=\"minus$num1\"";
echo "</td><td$id_minus><input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_bene_inv_elimina\" value=\"".mex("Aggiungi un bene",$pag)."\" onclick=\"agg_lin_bene_inv();\">";
...
$mostra_ca = $mostra_ca.$raggruppa_ca.$combina_ca;
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("OK",$pag)."\"><br>
</div></form>";
} # fine if ($passo == 12)
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"indietro\" value=\"< ".mex("indietro",$pag)."\">";
if ($errore != "SI") echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"avanti\" value=\"".mex("avanti",$pag)." >\">";
echo "</div></form><br>";
...
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"ok\" value=\"".mex("OK",$pag)."\"><br>
</div></form>";
} # fine if ($mostra_ok)
...
<h4 class=\"widgettitle\">" .mex("Inserisci i prezzi per l'anno",$pag). "</h4>
...
".mex("Cambia il numero delle tariffe","personalizza.php")." ".mex("per l'anno","personalizza.php")." $anno
 ".mex("a","personalizza.php")." <input type=\"text\" class=\"form-control input-sm\" class=\"form-control input-sm \"  name=\"nuovo_numero_tariffe\" size=\"5\" value=\"".$dati_tariffe['num']."\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"cambianumerotariffe\" value=\"".mex("Cambia","personalizza.php")."\">
...
<input type=\"hidden\" name=\"origine\" value=\"./creaprezzi.php\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("cambia l'ordine delle tariffe","personalizza.php"))."\">
...
".mex("Nome della",$pag)."<span class=\"field\"><select name=\"tipotariffa\"  class=\"uniformselect\" id=\"tariffa_cambia_nome\" onchange=\"aggiorna_nome_tariffa()\">
<option value=\"\">----</option>
$lista_opt_tariffe</select></span>: <input type=\"text\" class=\"form-control input-sm\" class=\"form-control input-sm\" id=\"nometariffa\" name=\"nometariffa\" size=\"30\">
...
<span class=\"field\"> 
<select  class=\"uniformselect\" name=\"tipotariffa\">
$lista_opt_tariffe_cambia
</select></span> <br>

<table class=\"table table-bordered responsive\" id=\"tab_prezzi\" style=\"margin-left: auto; margin-right: auto;\">
<colgroup>
                        <col class=\"con0\" />
                        <col class=\"con1\" />
                        <col class=\"con0\" />
...
<thead>
<tr style=\"line-height: 1; vertical-align: bottom;\">
<th></th>
<th style=\"width: 150px; font-size: smaller;\">".mex("prezzo per $parola_settimana",$pag)."</th>
<th></th>
<th style=\"width: 150px; font-size: smaller;\">".mex("prezzo per persona per $parola_settimana",$pag)."</th>
<th></th>
<th></th>
<th></th>
</tr></thead>";
...
echo " : </td>
<td ><input type=\"text\" class=\"form-control input-sm\" name=\"$prezzoperiodo\" value=\"".$$prezzoperiodo."\" size=\"150\"></td>
<td> + </td><td style=\"white-space: nowrap;\"><input type=\"text\" class=\"form-control input-sm\" name=\"$prezzoperiodo"."p\" value=\"".${$prezzoperiodo."p"}."\" size=\"150\">*$p_pers </td><td>$Euro</td>
<td id=\"minus$numperiodo\">";
if ($numperiodo == $numcaselle and $numcaselle > 1) echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_casella\" onclick=\"return elim_lin_tar();\" value=\"-\">";
echo "</td><td id=\"plus$numperiodo\">";
if ($numperiodo == $numcaselle and $numcaselle < $numcaselle_max) echo "<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_casella\" onclick=\"return agg_lin_tar();\" value=\"+\">";
echo "</td></tr>";
} # fine for $numperiodo
...
cella.innerHTML = cell_html;
cella = nlinea.insertCell(1);
cella.innerHTML = '<input type=\"text\" class=\"form-control input-sm\" name=\"prezzoperiodo'+numcaselle+'\" value=\"\" size=\"12\">';
cella = nlinea.insertCell(2);
cella.innerHTML = ' + ';
cella = nlinea.insertCell(3);
cella.style.whiteSpace = 'nowrap';
cella.innerHTML = '<input type=\"text\" class=\"form-control input-sm\" name=\"prezzoperiodo'+numcaselle+'p\" value=\"\" size=\"10\">*$p_pers ';
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"modifica\" value=\"".mex("inserisci o modifica i prezzi",$pag)."\">
</div></form><br>
<hr style=\"width: 95%\">";
/*
echo "</div><table><tr><td style=\"height: 2px;\"></td></tr></table>
<input class=\"btn btn-primary\" type=\"submit\" name=\"inserisci\" value=\"".mex("inserisci i nuovi prezzi",$pag)."\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"modifica\" value=\"".mex("modifica i prezzi già inseriti",$pag)."\">
</div></form><br>
<hr style=\"width: 95%\">";
*/
...
<span class=\"field\">
<select name=\"tipotariffa\" class=\"uniformselect\">";
...
echo mex("Settimane dal",$pag)."
 <span class=\"field\">
<select class=\"uniformselect\" name=\"inizioperiodosett1\" id=\"id_sdm149\" onChange=\"update_selected_dates('149')\">$option_domeniche1</select>
...
echo "</table></div><table><tr><td style=\"height: 2px;\"></td></tr></table>
<input class=\"btn btn-primary\" type=\"submit\" name=\"inserisci_settimanalmente\" value=\"".mex("inserisci o modifica i prezzi",$pag)."\">
</div></form><br>
<hr style=\"width: 95%\">";
} # fine if ($tipo_periodi == "g")
...
<span class=\"field\">
<select name=\"tipo_importa\" class=\"uniformselect\">
...
$select_nomi_tariffe = "";
echo "<span class=\"field\"> <select name=\"tariffa_a\" class=\"uniformselect\">
$lista_opt_tariffe_cambia
</select></span> ".mex("dalla",$pag)."<span class=\"field\"> <select name=\"tariffa_da\" class=\"uniformselect\">
$lista_opt_tariffe_cambia
</select></span> ".mex("aggiungendo",$pag)." <span style=\"white-space: nowrap;\">
<input type=\"text\" class=\"form-control input-sm\" class=\"form-control input-sm\" name=\"importa_percent\" size=\"3\" maxlength=\"3\" value=\"0\">
<span class=\"field\">
<select name=\"tipo_percent\" class=\"uniformselect\" id=\"tip_per\" onchange=\"att_dis_arrotond()\"> 
...
<input type=\"text\" class=\"form-control input-sm\" name=\"importa_arrotond\" id=\"imp_arr\" value=\"$arrotond_predef\" size=\"4\">)

<span class=\"field\">
<select name=\"parte_prezzo\" class=\"uniformselect\">
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"importa_tariffa\" value=\"".mex("importa",$pag)."\">
...
echo " <input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("cancella",$pag)."\">
</div></form>";
...
<input type=\"text\" class=\"form-control input-sm\" name=\"nomecostoagg\" size=\"24\" value=\"$nomecostoagg\">.<br>
".mex("Categoria",$pag).": <input type=\"text\" class=\"form-control input-sm\" name=\"categoria_ca\" value=\"$categoria_ca\" size=\"18\"> (".mex("opzionale",$pag).").<br>
".mex("Tipo di costo aggiuntivo",$pag).":

<span class=\"field\">
<select name=\"tipo_ca\" class=\"uniformselect\">";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"inseriscicosti\" value=\"".mex("Procedi nell'inserimento del nuovo costo aggiuntivo",$pag)."\">
</div></div></form><br>
<hr style=\"width: 95%\">";
...
<input type=\"text\" class=\"form-control input-sm\" name=\"nomecostoagg\" size=\"20\">
".mex("importando le caratteristiche da",$pag)."
<span class=\"field\">
<select name=\"costo_importa\" class=\"uniformselect\">
$opt_costi_agg
</select>
</span>
...
<span class=\"field\">
<select name=\"tipocostoagg\" class=\"uniformselect\">
...
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("inserisci",$pag)."\">.
<table><tr><td style=\"height: 6px;\"></td></tr></table>
</div></form><hr style=\"width: 95%\">";
...
<span class=\"field\">
 <select name=\"tipotariffa\" class=\"uniformselect\">
$lista_opt_tariffe
</select> </span>".mex("è",$pag).":</td><td onclick=\"document.getElementById('tipo_cap_perc').checked='1'\">
<label><input type=\"radio\" id=\"tipo_cap_perc\" name=\"tipo_caparra\" value=\"perc\" checked>
 ".mex("il",$pag)." </label><input type=\"text\" class=\"form-control input-sm\" name=\"caparra_percent\" size=\"2\" maxlength=\"3\"><label for=\"tipo_cap_perc\">%
 ".mex("della tariffa arrotondato a",$pag)."
 </label><input type=\"text\" class=\"form-control input-sm\" name=\"caparra_arrotond\" value=\"$arrotond_cap\" size=\"5\"><label for=\"tipo_cap_perc\">
 $Euro.</label></td></tr>
...
<input type=\"text\" class=\"form-control input-sm\" name=\"caparra_val\" size=\"5\"><label for=\"tipo_cap_val\"> $Euro.</label></td></tr>
...
".mex("il prezzo della tariffa per $parola_le prim$lettera_e",$pag)." </label><span class=\"field\"><select class=\"uniformselect\" name=\"caparra_gio\">";
for ($num1 = 1 ; $num1 <= 10 ; $num1++) echo "<option value=\"$num1\">$num1</option>";
echo "</select></span><label for=\"tipo_cap_gio\"> ".mex("$parola_settimane",$pag).".</label></td></tr>
</table>
<table><tr><td style=\"height: 2px;\"></td></tr></table><div style=\"text-align: center;\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"modificacaparra\" value=\"".mex("Inserisci o modifica la caparra",$pag)."\">
</div></div></form><br>
<hr style=\"width: 95%\">";
...
.mex("Le commissioni normali sulla",$pag)."
 ...
 <select class=\"uniformselect\" name=\"tipotariffa\">
$lista_opt_tariffe
</select></span> ".mex("sono",$pag).":</td><td onclick=\"document.getElementById('tipo_com_perc').checked='1'\">
<label><input type=\"radio\" id=\"tipo_com_perc\" name=\"tipo_commissioni\" value=\"perc\" checked>
 ".mex("il",$pag)." </label><input type=\"text\" class=\"form-control input-sm\" name=\"commissioni_percent\" size=\"2\" maxlength=\"3\"><label for=\"tipo_com_perc\">%
 ".mex("della",$pag)." </label><span class=\"field\"><select class=\"uniformselect\" name=\"commissioni_base\">
...
</select></span><label for=\"tipo_com_perc\"> ".mex("arrotondato a",$pag)."
</label><input type=\"text\" class=\"form-control input-sm\" name=\"commissioni_arrotond\" value=\"$arrotond_com\" size=\"5\"><label for=\"tipo_com_perc\"> $Euro.</label>
...
<input type=\"text\" class=\"form-control input-sm\" name=\"commissioni_val\" size=\"5\"><label for=\"tipo_com_val\"> $Euro ".mex("$parola_alla $parola_settimana",$pag).".
</label></td></tr></table>
<table><tr><td style=\"height: 2px;\"></td></tr></table><div style=\"text-align: center;\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Inserisci o modifica le commissioni normali",$pag)."\">
</div></div></form><br><br>
<form accept-charset=\"utf-8\" method=\"post\" action=\"creaprezzi.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
...
<input type=\"radio\" id=\"tipo_com_percp\" name=\"tipo_commissioni\" value=\"perc\" checked>
 ".mex("il",$pag)." </label><input type=\"text\" class=\"form-control input-sm\" name=\"commissioni_percent\" size=\"2\" maxlength=\"3\"><label for=\"tipo_com_percp\">%
 ".mex("della",$pag)." </label><span class=\"field\"><select class=\"uniformselect\" name=\"commissioni_base\">
<option value=\"t\">".mex("tariffa",$pag)."</option>
<option value=\"ts\">".mex("tariffa + sconto",$pag)."</option>
<option value=\"tsc\">".mex("tariffa + sconto + costi agg.",$pag)."</option>
</select></span><label for=\"tipo_com_percp\"> ".mex("arrotondato a",$pag)."
</label><input class=\"form-control input-sm\" type=\"text\" name=\"commissioni_arrotond\" value=\"$arrotond_com\" size=\"5\"><label for=\"tipo_com_percp\"> $Euro.
...
<input type=\"text\" class=\"form-control input-sm\" class=\"form-control input-sm\" name=\"commissioni_val\" size=\"5\"><label for=\"tipo_com_valp\"> $Euro ".mex("$parola_alla $parola_settimana",$pag).".
</label></td></tr></table>
<table><tr><td style=\"height: 2px;\"></td></tr></table><div style=\"text-align: center;\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Inserisci o modifica le commissioni in questo periodo",$pag)."\">
</div></div></form><br>
<hr style=\"width: 95%\">";
} # fine if ($priv_mod_tariffe != "n" and $lista_opt_tariffe)
...
echo "$lista_opt_tariffe
 ...
 <input type=\"text\" class=\"form-control input-sm\" name=\"tasse_percent\" size=\"2\" maxlength=\"4\">%
 <input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Inserisci o modifica le tasse",$pag)."\">
</div></form>
...
echo ucfirst(mex("valore a cui arrotondare le percentuali delle tasse","personalizza.php")).":
 <input class=\"fomr-control input-sm\" type=\"text\" name=\"nuovo_arrotond_tasse\" size=\"4\" value=\"$arrotond_tasse\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Cambia","personalizza.php")."\">
</div></form><br>";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"visualizza\" value=\"".mex("Vedi i prezzi già inseriti",$pag)."\">
</div></form><br>";
