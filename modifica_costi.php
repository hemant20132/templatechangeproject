...
if ($limite_ca != "n") {
if ($tipo_ca == "s" and $associasett != "s" and $numsett_ca != "t") { $errore = "SI"; $conflitti .= "9,10-18;"; }
if ($tipo_ca == "s" and $associasett != "s" and $periodi_permessi != "tutti" and $tipo_pp == "p") { $errore = "SI"; $conflitti .= "9,13-18;"; }
...
if ($mostra_ca != $dati_ca[$num_costo]['mostra'].$dati_ca[$num_costo]['raggruppa'].$dati_ca[$num_costo]['combina']) {
esegui_query("update $tablenometariffe set mostra_ca = '$mostra_ca' where idntariffe = '$idntariffe'");
$modificato = "SI";
} # fine if ($mostra_ca != $dati_ca[$num_costo]['mostra'].$dati_ca[$num_costo]['raggruppa'].$dati_ca[$num1]['combina'])
...
<small>18. </small>".mex("Limitarne il numero che è possibile avere contemporaneamente in uno stesso periodo",$pag)."?</td>
...
echo "<tr><td style=\"height: 1px;\"></td></tr><tr><td valign=\"top\">
<small>19. </small>".mex("Caratteristiche del costo<br> da mantenere quando si<br> modifica una prenotazione",$pag).":</td><td>
<table>";
