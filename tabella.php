...
echo "<div class=\"widgetbox\" style=\"position:relative;left:-15px;width:103%;\">
<h4 class=\"widgettitle\">" .mex("Tabella prenotazioni del",$pag)."</h4>
<div class=\"widgetcontent\">";

echo "<table class=\"table table-bordered responsive\" style=\"margin-left:auto;margin-right:10px;\">
<tr><td style=\"width: 100px;\" align=\"right\">";
if ($mese != 1) {
...
&nbsp;&nbsp;&nbsp;&nbsp;
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Aggiungi periodi",'visualizza_tabelle.php')."\">
</div></form>";
} # fine else if ($mese != $mese_fine_periodi)
echo "</td></tr></table>


<div style=\"position: relative;width:65%\" ondragstart=\"drg(event)\">

<table class=\"table table-bordered responsive\" width =\"50%\" cellwidth=\"15px\" style=\"position:relative;left:-15px;margin-right:auto;white-space:wrap;\">
<tbody>";
...
$prenotazione_presente = esegui_query("select
 ...
 $tableclienti.utente_inserimento
...
$utente_inserimento_cli = risul_query($prenotazione_presente,$prenota_corr,'utente_inserimento',$tableclienti);
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"tab3\" value=\"".mex("Visualizza la tabella per la stampa",$pag)."\">
</div></form>";
} # fine if ($tipo_periodi == "g")
else {
...
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
<input type=\"hidden\" id=\"m_corr_giu\" name=\"mese\" value=\"$mese\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"tab2\" value=\"".mex("Visualizza la tabella con i giorni",$pag)."\">
</div></form>";
