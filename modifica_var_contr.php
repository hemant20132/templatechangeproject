...
".mex("Array della variabile",$pag).": <span class=\"field\"><select class=\"uniformselect\" name=\"var_arr\">";
for ($num1 = 0 ; $num1 < $num_var_predef ; $num1++) {
echo "<option value=\"".$var_predef[$num1]."\">".mex2($var_predef[$num1])."</option>";
} # fine for $num1
echo "</select>
<input class=\"btn btn-primary\" type=\"submit\" name=\"torna\" value=\"".mex("Aggiungi",$pag)."\">
</div></form><br>";
} # fine if (!$var_arr)
else {
$var_arr_num = -1;
...
if ($tipo_arr != "dat" and $tipo_arr != "val" and $tipo_arr != "cop") $continua = "NO";
...
echo "<div class=\"widgetbox\">
   <h4 class=\"widgettitle\">". mex("Variabili personalizzate dei documenti",$pag)."</h4>
...
if ($option_var_pers) {
echo "<span class=\"field\"><select class=\"uniformselect\" name=\"var_pers_elimina\">
$option_var_pers
</select>
<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_var_pers\" value=\"".mex("Elimina",$pag)."\">";
} # fine if ($option_var_pers)
echo "&nbsp;&nbsp;&nbsp;<input name=\"nuova_var_pers\" size=\"20\" maxlength=\"50\" type=\"text\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_var_pers\" value=\"".mex("Aggiungi",$pag)."\">";
...
if ($option_arr_pers) {
echo "<span class=\"field\"><select class=\"uniformselect\" name=\"arr_pers_elimina\">
$option_arr_pers
</select>
<input class=\"btn btn-primary\" type=\"submit\" name=\"elimina_arr_pers\" value=\"".mex("Elimina",$pag)."\">";
} # fine if ($option_arr_pers)
echo "&nbsp;&nbsp;&nbsp;<input name=\"nuovo_arr_pers\" size=\"20\" maxlength=\"50\" type=\"text\">
<input class=\"btn btn-primary\" type=\"submit\" name=\"aggiungi_arr_pers\" value=\"".mex("Aggiungi",$pag)."\">";
if ($contr_cond and !$contr_importa_vc) echo " (<label><input type=\"checkbox\" name=\"solo_contr_cond\" value=\"SI\" checked> ".mex("solo al documento",$pag)." $contr_cond</label>)";
echo "</div></form><br>";
...
<span class=\"field\"><select class=\"uniformselect\" name=\"contr_cond\">
$opt_contr</select>
<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Modifica",$pag)."\">
</div></form>";
...
<table cellspacing=0><tr><td><span class=\"field\"><select class=\"uniformselect\" class=\"smallsel\" name=\"salta_a\">$opt_giu</select></td><td>
<button type=\"submit\">
...
</button></td><td><span class=\"field\"><select class=\"uniformselect\" class=\"smallsel\" name=\"salta_a\">$opt_su</select>
...
<input class=\"smallbtn btn-primary\" type=\"submit\" value=\"".mex("Modifica",$pag)."\">
</div></form></td>
...
<input type=\"hidden\" name=\"cambia_qualcosa\" value=\"SI\">
<input type=\"hidden\" name=\"num_cond\" value=\"$num_cond\">
<input class=\"smallbtn btn-primary\" type=\"submit\" name=\"elimina_cond\" value=\"".mex("Elimina",$pag)."\">
</div></form></td></tr>";
...
else echo "<span class=\"field\"><select class=\"uniformselect\" name=\"tipo_contr_imp\">
...
<span class=\"field\"><select class=\"uniformselect\" name=\"contr_imp\">
<option value=\"\">----</option>
...
&nbsp;&nbsp;<input class=\"btn btn-primary\" type=\"submit\" value=\"".mex("Visualizza le condizioni del documento",$pag)." $contr_importa_vc\">
</div></form>";
...
echo " <span class=\"field\"><select class=\"uniformselect\" name=\"inizializza\">
...
$fr_se = mex("se",$pag);
if ($num_se == 2) {
echo "<td><span class=\"field\"><select class=\"uniformselect\" name=\"and_or\">
...
echo "<td>$fr_se</td><td><span class=\"field\"><select class=\"uniformselect\" name=\"var_se$num1\">
".str_replace("\"".${"var_se".$num1}."\">","\"".${"var_se".$num1}."\" selected>",$option_var_predef)."
</select></td><td><span class=\"field\"><select class=\"uniformselect\" name=\"cond$num1\">
...
input type=\"text\" class=\"form-control input-sm\" name=\"val_se_txt$num1\" value=\"".${"val_se_txt".$num1}."\" size=\"20\" maxlength=\"750\" onfocus=\"document.getElementById('val_se_txt$num1').checked='1'\">
</td></tr><tr><td><input type=\"radio\" id=\"val_se_sel$num1\" name=\"tipo_val_se$num1\" value=\"var\"$chk_var></td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"val_se_sel$num1\" onfocus=\"document.getElementById('val_se_sel$num1').checked='1'\">
".str_replace("\"".${"val_se_sel".$num1}."\">","\"".${"val_se_sel".$num1}."\" selected>",$option_var_predef)."
</select></td></tr></table></td>";
if ($num1 == $num_se) {
if ($num_se > 1) echo "<td><input name=\"canc_se\" class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("elimina questo &quot;se&quot;",$pag))."\"></td></tr><tr><td colspan=\"6\"></td>";
echo "<td><input name=\"agg_se\" class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("aggiungi un altro &quot;se&quot;",$pag))."\"></td>";
} # fine if ($num1 == $num_se)
echo "</tr>";
} # fine for $num1
...
</td><td><span class=\"field\"><select class=\"uniformselect\" name=\"oper_str\">
<option value=\"=\"$sel_ug>".ucwords(mex("uguaglia",$pag))."</option>
<option value=\".=\"$sel_div>".ucwords(mex("concatena",$pag))."</option>
</select></td><td><span class=\"field\"><select class=\"uniformselect\" name=\"var_allora\">
...
input type=\"text\" class=\"form-control input-sm\" name=\"val_allora_txt\" value=\"$val_allora_txt\" size=\"20\" maxlength=\"750\" onfocus=\"document.getElementById('val_all_txt').checked='1'\">
</td></tr><tr><td><input type=\"radio\" id=\"val_all_sel\" name=\"tipo_val_allora\" value=\"var\"$chk_var></td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"val_allora_sel\" onfocus=\"document.getElementById('val_all_sel').checked='1'\">
...
input type=\"text\" class=\"form-control input-sm\" name=\"val_sost1_txt\" value=\"$val_sost1_txt\" size=\"20\" maxlength=\"750\" onfocus=\"document.getElementById('val_s1_txt').checked='1'\">
</td></tr><tr><td><input type=\"radio\" id=\"val_s1_sel\" name=\"tipo_val_sost1\" value=\"var\"$chk_var_s1></td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"val_sost1_sel\" onfocus=\"document.getElementById('val_s1_sel').checked='1'\">
...
input type=\"text\" class=\"form-control input-sm\" name=\"val_sost2_txt\" value=\"$val_sost2_txt\" size=\"20\" maxlength=\"750\" onfocus=\"document.getElementById('val_s2_txt').checked='1'\">
</td></tr><tr><td><input type=\"radio\" id=\"val_s2_sel\" name=\"tipo_val_sost2\" value=\"var\"$chk_var_s2></td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"val_sost2_sel\" onfocus=\"document.getElementById('val_s2_sel').checked='1'\">
...
</td><td>".ucfirst(mex("troncare",$pag))." </td><td><span class=\"field\"><select class=\"uniformselect\" name=\"var_trunc\">
".str_replace("\"$var_trunc\">","\"$var_trunc\" selected>",$option_var_pers)."
</select></td><td>".str_replace(" ","&nbsp;",mex("dopo",$pag))."</td><td>
input type=\"text\" class=\"form-control input-sm\" name=\"val_trunc\" value=\"$val_trunc\" size=\"3\" maxlength=\"12\"></td><td>
".str_replace(" ","&nbsp;",mex("caratteri",$pag))."</td><td>
<td>(".str_replace(" ","&nbsp;",mex("se mancanti riempire con",$pag))."</td><td>
input type=\"text\" class=\"form-control input-sm\" name=\"val_trunc2\" value=\"$val_trunc2\" size=\"10\" maxlength=\"750\"></td>
<td>".str_replace(" ","&nbsp;",mex("la parte",$pag))."</td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"pos_trunc2\">
...
</td><td>".ucfirst(mex("porre",$pag))." </td><td><span class=\"field\"><select class=\"uniformselect\" name=\"var_oper\">
".str_replace("\"$var_oper\">","\"$var_oper\" selected>",$option_var_pers)."
</select></td><td>".str_replace(" ","&nbsp;",mex("uguale a",$pag))."</td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"var_oper2\">
".str_replace("\"$var_oper2\">","\"$var_oper2\" selected>",$option_var_predef)."
</select></td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"operatore\">
...
input type=\"text\" class=\"form-control input-sm\" name=\"val_oper_txt\" value=\"$val_oper_txt\" size=\"15\" maxlength=\"750\" onfocus=\"document.getElementById('val_oper_txt').checked='1'\">
</td></tr><tr><td><input type=\"radio\" id=\"val_oper_sel\" name=\"tipo_val_oper\" value=\"var\"$chk_var></td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"val_oper_sel\" onfocus=\"document.getElementById('val_oper_sel').checked='1'\">
".str_replace("\"$val_oper_sel\">","\"$val_oper_sel\" selected>",$option_var_predef)."
</select></td></tr></table>
</td><td>(".str_replace(" ","&nbsp;",mex("arrotondato a",$pag))."</td><td>
input type=\"text\" class=\"form-control input-sm\" name=\"val_arrotond\" value=\"$val_arrotond\" size=\"15\" maxlength=\"50\"></td><td>)
...
</td><td>".ucfirst(mex("porre",$pag))." </td><td><span class=\"field\"><select class=\"uniformselect\" name=\"var_data\">
".str_replace("\"$var_data\">","\"$var_data\" selected>",$option_var_pers)."
</select></td><td>".str_replace(" ","&nbsp;",mex("uguale a",$pag))."</td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"subdata\">
...
<span class=\"field\"><select class=\"uniformselect\" name=\"var_data2\">
".str_replace("\"$var_data2\">","\"$var_data2\" selected>",$option_var_predef_data)."
</select></td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"oper_giorni\">
<option value=\"+\"$sel_piu>+</option>
<option value=\"-\"$sel_men>-</option>
</select></td><td>
input type=\"text\" class=\"form-control input-sm\" name=\"num_giorni\" value=\"$num_giorni\" size=\"3\" maxlength=\"150\">
</td><td>
<span class=\"field\"><select class=\"uniformselect\" name=\"tipo_giorni\">
...
<span class=\"field\"><select class=\"uniformselect\" name=\"arr_azz\">
...
<span class=\"field\"><select class=\"uniformselect\" name=\"array\">
".str_replace("\"$array\">","\"$array\" selected>",$opt_arr_var_non_predef)."
</select></td><td>
<b style=\"font-size: 260%;\">{</b></td><td>
<table cellspacing=\"0\"><tr onclick=\"document.getElementById('arr_dat').checked='1'\"><td>
...
<td>input type=\"text\" class=\"form-control input-sm\" name=\"lista_val\" value=\"$lista_val\" size=\"26\"></td>
...
<td><span class=\"field\"><select class=\"uniformselect\" name=\"array2\">
...
</td><td><span class=\"field\"><select class=\"uniformselect\" name=\"break_cont\">
...
$input_cond_contr
<div class=\"txtcenter\">
<input class=\"btn btn-primary\" type=\"submit\" value=\"".ucfirst(mex("annulla",$pag))."\">
</div></div></form><br>";
} # fine if ($num_cond_mod)
echo "</div><br>";
...
<input class=\"btn btn-primary\" type=\"submit\" name=\"torna\" value=\"".mex("Modifica il documento",$pag)." $contr_cond\">
</div></form><br>";
} # fine if ($contr_cond)
